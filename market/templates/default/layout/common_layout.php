...
$(function(){
	...
	$('#button').click(function(){
	    if ($('#keyword').val() == '') {
		    if ($('#keyword').attr('data-value') == '') {
				...
				window.location.href="<?php echo DISTRIBUTE_SITE_URL?>/index.php?con=search&fun=index&keyword="+$('#keyword').attr('data-value');
			    return false;
			}
	    }
	});
	...
	$('#keyword').focus(function(){$('#search-tip').show()}).autocomplete({
        ...
        source: function (request, response) {
            $.getJSON('<?php echo DISTRIBUTE_SITE_URL;?>/index.php?con=search&fun=auto_complete', request, function (data, status, xhr) {
        ...
        <dd>
          ...
          <div class="browse-history">
            <div class="part-title">
              <h4>最近浏览的商品</h4>
              <span style="float:right;"><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_goodsbrowse&fun=list">全部浏览历史</a></span>
            </div>
            <ul>
