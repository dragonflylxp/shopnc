...
<div class="base-layout">
  <div class="mainbox">
    <form method="post" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=inform&c_id=<?php echo $output['c_id'];?>" id="inform_form" onsubmit="ajaxpost('inform_form', '<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=inform&c_id=<?php echo $output['c_id'];?>', '', 'onerror');">
        ...
        <thead>
          ...
          <tr>
            ...
            <td colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
              <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=delinform&c_id=<?php echo $output['c_id'];?>" name="i_id" confirm="<?php echo $lang['nc_ensure_del'];?>" title="<?php echo $lang['nc_delete'];?>"><i class="ac5"></i><?php echo $lang['nc_delete'];?></a></td>
          </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
          <tr>
            ...
            <th colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
              <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=delinform&c_id=<?php echo $output['c_id'];?>" name="i_id" confirm="<?php echo $lang['nc_ensure_del'];?>" title="<?php echo $lang['nc_delete'];?>"><i class="ac5"></i><?php echo $lang['nc_delete'];?></a> </th>
          </tr>
          <tr>
...
function delinform(i_id){
	showDialog('<?php echo $lang['nc_ensure_del'];?>', 'confirm', '', function(){
		_uri = CIRCLE_SITE_URL+'/index.php?con=manage&fun=delinform&c_id='+c_id+'&i_id='+i_id;
		ajaxget(_uri);
	});
}
//Ajax提示
