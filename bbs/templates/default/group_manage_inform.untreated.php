...
<div class="base-layout">
  <div class="mainbox">
    <form method="post" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage_inform&fun=inform&c_id=<?php echo $output['c_id'];?>" id="inform_form" onsubmit="ajaxpost('inform_form', '<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage_inform&fun=inform&c_id=<?php echo $output['c_id'];?>', '', 'onerror');">
