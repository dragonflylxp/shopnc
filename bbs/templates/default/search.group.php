...
<div class="search-page">
  ...
  <?php if(!empty($output['circle_list'])){?>
    ...
    <div class="no-theme">
      ...
      <br>
      <span><?php echo $lang['circle_search_null_msg'];?><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=index&fun=add_group&kw=<?php echo $_GET['keyword'];?>"><?php echo $lang['circle_instantly_create'];?></a></span>
    </div>
    <div></div>
    <?php }?>
  </div></div>
