      ...
      <thead>
        ...
        <tr>
          ...
          <td colspan="3"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=class_del&c_id=<?php echo $output['c_id'];?>" name="thc_id" confirm="<?php echo $lang['nc_ensure_del'];?>"><i class="ac5"></i><?php echo $lang['nc_delete'];?></a></td>
          <?php }?>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="tl"><dl class="group-base">
              <dt class="group-name"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&c_id=<?php echo $val['friendship_id'];?>" target="_blank"><?php echo $val['friendship_name'];?></a></dt>
      ...
      <tfoot>
        <tr>
          ...
          <th colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=friendship_del&c_id=<?php echo $output['c_id'];?>" name="fs_id" confirm="<?php echo $lang['nc_ensure_del'];?>"><i class="ac5"></i><?php echo $lang['nc_delete'];?></a> </th>
        </tr>
      </tfoot>
      <?php }?>
    </table>
...
$(function(){
    ...
    $('a[nctype="add_fs"]').click(function(){
    	_uri = "<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=friendship_add&c_id="+c_id;
    	CUR_DIALOG = ajax_form('add_friendship', '<?php echo $lang['fcircle_add'];?>', _uri, 520);
	});
});
function edit_fs(id){
	_uri = "<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=friendship_edit&c_id="+c_id+"&fs_id="+id;
...
function del_fs(id){
	showDialog('<?php echo $lang['nc_ensure_del'];?>', 'confirm', '', function(){
		_uri = "<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=friendship_del&c_id="+c_id+"&fs_id="+id;
		ajaxget(_uri);
	});
}
</script>