    ...
    <div class="mainbox">
      <div class="base-tab-menu">
        <ul class="base-tabs-nav">
          <li class="selected"><a href="index.php?con=group&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_theme'];?></a></li>
          <li><a href="index.php?con=group&fun=group_member&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_firend'];?></a></li>
          <li><a href="index.php?con=group&fun=group_goods&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['nc_goods'];?></a></li>
        </ul>
      </div>
      <div class="group-list-bar">
        <div class="group-theme-class"> <a href="index.php?con=group&c_id=<?php echo $output['c_id'];?>" <?php if($output['thc_id'] == ''){?>class="selected"<?php }?>><i></i><?php echo $lang['circle_all'];?></a>
        ...
        <div class="group-theme-read-control">
          <div class="read-model">
            <a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&cream=1&c_id=<?php echo $output['c_id'];?>" title="<?php echo $lang['circle_digest_theme'];?>"><i class="digest"></i></a>
        ...
        <ul class="group-theme-list">
          ...
          <li nctype="li<?php echo $val['theme_id'];?>">
            ...
            <div class="theme-title">
              ...
              <a href="index.php?con=theme&fun=theme_detail&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $val['theme_id'];?>" class="theme-name"><?php echo $val['theme_name'];if($val['theme_readperm'] > 0){ echo '<font>'.L('nc_brackets1,circle_read_permissions').'lv'.$val['theme_readperm'].L('nc_brackets2').'</font>';}?></a>
              <?php }else{?>
            ...
            <?php }?>
            <div class="theme-writer"><i title="<?php echo $lang['circle_author'];?>"></i><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=sns_circle&mid=<?php echo $val['member_id'];?>" target="_blank" title="<?php echo $val['member_name'];?>"><?php echo $val['member_name'];?></a><?php echo memberIdentity($val['is_identity']);?></div>
            ...
            <div class="theme-lastspeak-name"><i title="<?php echo $lang['circle_lastspeak_member'];?>"></i><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=sns_circle&mid=<?php echo $val['lastspeak_id'];?>" target="_blank" title="<?php echo $val['lastspeak_name'];?>"><?php echo $val['lastspeak_name'];?></a></div>
