...
<div class="my-info">
  ...
  <dl>
    <dt>
      <h2><a href="index.php?con=p_center" target="_blank"><?php echo $_SESSION['member_name'];?></a></h2>
    </dt>
...
<div class="side-tab-nav">
  ...
  <div class="my-circle-list tabs-panel">
    ...
    <dl <?php if($val['is_identity'] == 3){?>nctype="member"<?php }?>>
      <dt class="name"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&c_id=<?php echo $val['circle_id'];?>" title="<?php echo $val['circle_name'];?>" ><?php echo $val['circle_name'];?></a></dt>
