    ...
    <div class="mainbox">
      <div class="base-tab-menu">
        <ul class="base-tabs-nav">
          <li><a href="index.php?con=group&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_theme'];?></a></li>
          <li><a href="index.php?con=group&fun=group_member&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_firend'];?></a></li>
          <li class="selected"><a href="index.php?con=group&fun=group_goods&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['nc_goods'];?></a></li>
        </ul>
      </div>
...
$(function(){
	...
	$("a[nc_type='likebtn']").live('click',function(){
        ...
        //ajaxget(SITEURL+'/index.php?con=member_snsindex&fun=editlike&inajax=1&id='+data_str.gid);
        ajaxget(CIRCLE_SITE_URL+'/index.php?con=member_snsindex&fun=editlike&inajax=1&id='+data_str.gid);
	});
