...
<div class="sidebar">
  ...
  <div class="my-info">
    ...
    <dl>
      <dt>
        <h3><a href="index.php?con=p_center" target="_blank"><?php echo $lang['nc_inro_personal_center'];?></a></h3>
      </dt>
      <dd>
  ...
  <div class="side-tab-nav">
    ...
    <div class="sidebar-circle-info tabs-panel tabs-hide">
      ...
      <dl>
        ...
        <dd><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?con=sns_circle&fun=theme&mid=<?php echo $output['creator']['member_id'];?>" class="master" title="<?php echo $output['creator']['member_name'];?>" target="_blank"><i></i><?php echo $output['creator']['member_name'];?></a></dd>
      </dl>
      <dl>
        ...
        <dd>
          ...
          <a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?con=sns_circle&mid=<?php echo $val['member_id'];?>" class="moderator" title="<?php echo $val['member_name'];?>" target="_blank"><i></i><?php echo $val['member_name'];?></a>
          <?php }?>
          <?php }else{?>
  ...
  <div class="sidebar-box">
    ...
    <div class="content">
      <ul class="sidebar-circle-links">
        ...
        <li><span class="thumb size32"><i></i><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&c_id=<?php echo $val['friendship_id'];?>" title="<?php echo $val['friendship_name'];?>"><img src="<?php echo circleLogo($val['friendship_id']);?>" /></a></span></li>
        <?php }?>
      </ul>
    </div>
  </div>
