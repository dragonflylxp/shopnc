...
<div class="eject_con group_apply">
  ...
  <form id="apply_form" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&fun=apply&c_id=<?php echo $output['c_id'];?>" method="post">
...
$(function(){
    ...
    $('#apply_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('apply_form', '<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&fun=apply&c_id=<?php echo $output['c_id'];?>', '', 'onerror');
    	},
        rules : {
        	apply_content : {
                required : true,
