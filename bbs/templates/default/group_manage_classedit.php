...
<div class="eject_con">
  <div id="warning"></div>
  <form id="addclass_form" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=class_edit&c_id=<?php echo $output['c_id'];?>" method="post" class="base-form-style">
...
$(function(){
    ...
    $('#addclass_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('addclass_form', '<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=class_edit&c_id=<?php echo $output['c_id'];?>', '', 'onerror');
    	},
        rules : {
        	name : {
                required : true,
