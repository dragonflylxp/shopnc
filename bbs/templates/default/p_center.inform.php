    ...
    <table class="base-table-style">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name'];?></a></td>
          <td>
      ...
      <tfoot>
        <tr>
          ...
          <th colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=p_center&fun=delinform" name="i_id" confirm="<?php echo $lang['nc_ensure_del'];?>" title="<?php echo $lang['nc_delete'];?>"><i class="ac5"></i><?php echo $lang['nc_delete'];?></a>
          </th>
        </tr>
...
function delinform(i_id){
	showDialog('<?php echo $lang['nc_ensure_del'];?>', 'confirm', '', function(){
		_uri = CIRCLE_SITE_URL+'/index.php?con=p_center&fun=delinform&i_id='+i_id;
		ajaxget(_uri);
	});
}
</script>