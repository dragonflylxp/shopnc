  ...
  <div class="mainbox">
    <div class="base-tab-menu">
      <ul class="base-tabs-nav">
        ...
        <li class="selected"><a href="index.php?con=group&fun=group_member&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_firend'];?></a></li>
      ...
      <h3><?php echo $lang['circle_my_cart'];?></h3>
        <li>
          <dl class="member-info">
            <dt class="member-name"><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?con=sns_circle&mid=<?php echo $output['cm_info']['member_id'];?>"><?php echo $output['cm_info']['member_name'];?></a></dt>
...
$(function(){
	$('a[nctype="cmEdit"]').click(function(){
		if(_ISLOGIN){
    		_uri = "<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&fun=group_memberedit&inajax=1&c_id=<?php echo $output['c_id'];?>";
