      ...
      <thead>
        ...
        <tr>
          ...
          <td colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=applying_manage&type=yes&c_id=<?php echo $output['c_id'];?>" name="cm_id"><i class="ac6"></i><?php echo $lang['circle_pass'];?></a>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=applying_manage&type=no&c_id=<?php echo $output['c_id'];?>" name="cm_id" confirm="<?php echo $lang['circle_refuse_confirm'];?>"><i class="ac7"></i><?php echo $lang['circle_refuse'];?></a></td>
        </tr>
        <?php }?>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td><dl class="member-base"><dt class="name"><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=sns_circle&mid=<?php echo $val['member_id'];?>" target="_blank"><?php echo $val['member_name'];?></a></dt><dd class="member-avatar-s"><img src="<?php echo getMemberAvatarForID($val['member_id']);?>" /></dd>
            </dl></td>
      ...
      <tfoot>
        <tr>
          ...
          <th colspan="20"><label for="all" class="handle-btn"><i class="ac0"></i><?php echo $lang['nc_check_all'];?></label>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=applying_manage&type=yes&c_id=<?php echo $output['c_id'];?>" name="cm_id"><i class="ac6"></i><?php echo $lang['circle_pass'];?></a>
            <a href="javascript:void(0);" class="handle-btn" nctype="batchbutton" uri="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=applying_manage&type=no&c_id=<?php echo $output['c_id'];?>" name="cm_id" confirm="<?php echo $lang['circle_refuse_confirm'];?>"><i class="ac7"></i><?php echo $lang['circle_refuse'];?></a></th>
        </tr>
      </tfoot>
      <?php }?>
    </table>
...
function applyingManage(type, id){
	_uri = "<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=applying_manage&type="+type+"&c_id=<?php echo $output['c_id'];?>&cm_id="+id;
	if(type == 'yes'){
		ajaxget(_uri);
	}else if(type == 'no'){
