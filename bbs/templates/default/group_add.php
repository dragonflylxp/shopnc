...
<div class="add-group">
  <dl class="top-box">
    <dt>
      <h3><?php echo $lang['circle_create_a_group'];?><i><?php echo $lang['circle_first_from'];?> <a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=search&fun=group"><?php echo $lang['nc_find_fascinating'];?></a> <?php echo $lang['circle_find_like_group'];?></i></h3>
  ...
  <div class="base-form-style">
    <form method="post" id="groupadd_form" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=index&fun=add_group">
      ...
      <dl>
        ...
        <dd>
          ...
          <?php echo $lang['circle_my_read_carefully_agree'];?><a target="_blank" href="<?php echo SHOP_SITE_URL;?>/index.php?con=document&code=create_circle"><?php echo $lang['circle_notice_for_use']?></a><?php echo $lang['circle_all_terms'];?></dd>
      </dl>
      <dl class="bottom">
        <dt>&nbsp;</dt>
...
$(function(){
    ...
    $('#groupadd_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('groupadd_form', '<?php echo CIRCLE_SITE_URL;?>/index.php?con=index&fun=add_group', '', 'onerror');
    	},
        rules : {
        	c_name : {
                required : true,
            	...
            	maxlength : 12,
            	remote : {
            		url : 'index.php?con=index&fun=check_circle_name',
                    type: 'get',
                    data:{
                    	name : function(){
                            return $('#c_name').val();
