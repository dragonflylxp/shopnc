...
<div class="base-layout">
  <div class="mainbox">
    ...
    <div class="my-theme-list">
      ...
      <div class="pagination bottom"><a href="javascript:void(0);" class="submit-btn" style=" float: right;" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){ajaxget('<?php echo CIRCLE_SITE_URL?>/index.php?con=p_center&fun=clr_recycled')}"><?php echo $lang['p_center_clear_recycle'];?></a><?php echo $output['show_page'];?></div>
      <?php }else{?>
