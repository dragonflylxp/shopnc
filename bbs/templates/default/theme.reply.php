...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="reply_form1" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=theme&fun=save_reply&type=adv&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>">
...
$(function(){
    ...
    $('#reply_form1').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('reply_form1', CIRCLE_SITE_URL+'/index.php?con=theme&fun=save_reply&c_id='+c_id+'&t_id='+t_id, '', 'onerror');
    	},
        rules : {
        	replycontent : {
                required : true
