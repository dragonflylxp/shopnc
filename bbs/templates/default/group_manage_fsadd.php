...
<div class="eject_con">
  ...
  <form id="fsadd_form" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=friendship_add&c_id=<?php echo $output['c_id'];?>" method="post" class="base-form-style">
...
$(function(){
    ...
    $('#fsadd_form').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('fsadd_form', '<?php echo CIRCLE_SITE_URL;?>/index.php?con=manage&fun=friendship_add&c_id='+c_id, '', 'onerror');
    	},
        rules : {
        	cid : {
            	min : 1
	...
	$('a[nctype="fsadd_search"]').click(function(){
		...
		$.getJSON(CIRCLE_SITE_URL+'/index.php?con=manage&fun=search_circle&c_id='+c_id+'&name='+name, function(data){
			if(data){
