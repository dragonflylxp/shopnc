  ...
  <div class="warp-all">
    ...
    <div class="circle-search" id="circleSearch">
      <form id="form_search" method="get" action="<?php echo CIRCLE_SITE_URL;?>/index.php" >
        ...
        <div class="radio-box">
          <label>
            <input name="fun" value="theme" type="radio" <?php if($output['search_sign']=='theme' || !isset($output['search_sign'])){?>checked="checked"<?php }?> />
            <h5><?php echo $lang['search_theme'];?></h5></label>
          <label>
            <input name="fun" value="group" type="radio" <?php if($output['search_sign']=='group'){?>checked="checked"<?php }?> />
            <h5><?php echo $lang['search_circle'];?></h5></label>
        </div>
      </form>
    </div>
    <div class="circle-user">
      <h2><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?con=search&fun=group"><?php echo $lang['nc_find_fascinating'];?></a></h2>
