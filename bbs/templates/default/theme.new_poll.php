...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="theme_form" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=theme&fun=save_theme&sp=1&c_id=<?php echo $output['c_id'];?>">
      <input type="hidden" name="form_submit" value="ok" />
      <div class="quick-thread">
        <div class="base-tab-menu">
          <ul class="base-tabs-nav">
            <li><a href="index.php?con=theme&fun=new_theme&c_id=<?php echo $output['c_id'];?>"><?php echo $lang['circle_new_theme'];?></a></li>
...
$(function(){
    ...
    $('#theme_form').validate({
    	...
    	submitHandler:function(form){
    		...
    		ajaxpost('theme_form', CIRCLE_SITE_URL+'/index.php?con=theme&fun=save_theme&c_id='+c_id, '', 'onerror');
    	},
    	focusInvalid : false,
        rules : {
        	name : {
