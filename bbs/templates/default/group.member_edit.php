...
<div class="eject_con group_apply">
  ...
  <form id="memberedit" action="<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&fun=group_memberedit&c_id=<?php echo $output['c_id'];?>" method="post">
...
$(function(){
    ...
    $('#memberedit').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('memberedit', '<?php echo CIRCLE_SITE_URL;?>/index.php?con=group&fun=group_memberedit&c_id=<?php echo $output['c_id'];?>', '', 'onerror') 
    	},
        rules : {
            intro : {
                required : true,
