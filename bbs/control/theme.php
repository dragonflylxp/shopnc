...
class themeControl extends BaseCircleThemeControl{
    ...
    public function ajax_quickreplyOp(){
        ...
        $data = array();
        $data['form_action'] = CIRCLE_SITE_URL.'/index.php?con=theme&fun=save_reply&type=quick&c_id='.$this->c_id.'&t_id='.$this->t_id;
    ...
    public function save_themeOp(){
        if(chksubmit()){
            ...
            if($themeid){
                ...
                showDialog(L('nc_release_op_succ'), CIRCLE_SITE_URL.'/index.php?con=theme&fun=theme_detail&c_id='.$this->c_id.'&t_id='.$themeid, 'succ');
            }else{
    ...
    public function edit_themeOp(){
        ...
        if(chksubmit()){
            ...
            if($rs){
                ...
                showDialog(L('nc_deit_op_succ'), CIRCLE_SITE_URL.'/index.php?con=theme&fun=theme_detail&c_id='.$this->c_id.'&t_id='.$this->t_id, 'succ');
            }else{
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if($rs){
                    ...
                    showDialog(L('nc_common_op_succ'), 'index.php?con=theme&fun=theme_detail&c_id='.$this->c_id.'&t_id='.$this->t_id, 'succ');
                }
            }
        }
