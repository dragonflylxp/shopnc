...
class theme_shareControl extends BaseCircleControl{
        ...
        if(chksubmit()){
            ...
            if ($result){
                ...
                if (C('share_isuse') == 1){
                    ...
                    $params['url'] = CIRCLE_SITE_URL."/index.php?con=theme&fun=theme_detail&c_id=".$this->c_id."&t_id=".$theme_info['theme_id'];
    ...
    private function traceContent($theme_info, $affix_list){
        ...
        $url = CIRCLE_SITE_URL."/index.php?con=theme&fun=theme_detail&c_id=".$this->c_id."&t_id=".$theme_info['theme_id'];
        if(!empty($affix_list[0])){
