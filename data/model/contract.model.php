...
class contractModel extends Model {
    ...
    public function getContractCount(){
        $condition['cta_auditstate'] = 0;
        return $this->table('contract_apply')->where($condition)->count();
    }

    /*
 * 获取保障项目退出申请未审核数量
 * */
    public function getContractQuitCount(){
        $condition['ctq_auditstate'] = 0;
        return $this->table('contract_quitapply')->where($condition)->count();
    }
