...
$config = array();
$config['shop_site_url']        = 'https://shop99.yifensport.com/mall';
$config['cms_site_url']         = 'https://shop99.yifensport.com/news';
$config['microshop_site_url']   = 'https://shop99.yifensport.com/manshow';
$config['circle_site_url']      = 'https://shop99.yifensport.com/bbs';
$config['admin_site_url']       = 'https://shop99.yifensport.com/myadmin';
$config['mobile_site_url']      = 'https://shop99.yifensport.com/mob';
$config['seller_site_url']      = 'https://shop99.yifensport.com/seller';
$config['wap_site_url']         = 'https://shop99.yifensport.com/wap';
$config['chat_site_url']        = 'https://shop99.yifensport.com/chat';
$config['node_site_url']        = 'https://shop99.yifensport.com/:8090';
$config['delivery_site_url']    = 'https://shop99.yifensport.com/service';
$config['chain_site_url']       = 'https://shop99.yifensport.com/storeschain';
$config['member_site_url']      = 'https://shop99.yifensport.com/user';
$config['distribute_site_url']  = 'https://shop99.yifensport.com/market';
$config['data_site_url']      = 'https://shop99.yifensport.com';//by:511613932
$config['upload_site_url']      = 'https://shop99.yifensport.com/data/upload';
$config['resource_site_url']    = 'https://shop99.yifensport.com/data/resource';
...
$config['db']['master']['dbname']       = 'gaimulv';
