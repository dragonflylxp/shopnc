...
class WxPayConfig
{
	 ...
	 * @var path
	 */
	const SSLCERT_PATH = '/home/cert/apiclient_cert_app.pem';//如：/home/cert/apiclient_cert.pem
	const SSLKEY_PATH = '/home/cert/apiclient_key_app.pem';//如：/home/cert/apiclient_key.pem
