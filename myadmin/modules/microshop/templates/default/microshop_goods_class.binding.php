...
<form id="add_form" method="POST" action="index.php?con=goods_class&fun=goodsclass_binding_save">
...
$(document).ready(function(){
    ...
    $("#goods_class").change(function(){
        ...
        $.getJSON('index.php?con=goods_class&fun=goodsclass_get',{class_id:$(this).val()},function(data){
            if(data != null)
            {
