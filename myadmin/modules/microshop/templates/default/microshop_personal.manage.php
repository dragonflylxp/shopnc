...
<script>
$(function() {
    var flexUrl = 'index.php?con=personal&fun=personal_manage_xml';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?con=personal&fun=personal_drop&personal_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$('a[data-ie-column]').live('click', function() {
    $.get('index.php?con=personal&fun=ajax&branch=personal_commend', {
...
$("span[data-live-inline-edit='microshop_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?con=personal&fun=personal_sort_update', {
            id: $this.parents('tr').attr('data-id'),
            value: v2
        }, function(d) {
            if (d.result) {
