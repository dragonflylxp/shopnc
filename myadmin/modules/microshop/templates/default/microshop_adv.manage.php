...
<div class="page">
  ...
  <div class="flex-table-search">
    <form method="get" name="formSearch">
      <input type="hidden" value="adv" name="con">
      <input type="hidden" value="adv_manage" name="fun">
      <div class="sDiv">
    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr data-id="<?php echo $val['adv_id']; ?>">
          ...
          <td class="handle"><a href="index.php?con=adv&fun=adv_drop&adv_id=<?php echo $val['adv_id'];?>" class="btn red confirm-del"><i class="fa fa-trash-o"></i><?php echo $lang['nc_del'];?></a><a href="index.php?con=adv&fun=adv_edit&adv_id=<?php echo $val['adv_id'];?>" class="btn blue"><i class="fa fa-pencil-square-o"></i><?php echo $lang['nc_edit'];?></a></td>
	...
	$('.flex-table').flexigrid({
        ...
        buttons : [
				   ...
				   {display: '<i class="fa fa-trash"></i>批量删除', name : 'del', bclass : 'del', title : '将选定行数据批量删除', onpress : function() {
                    ...
                    location.href = 'index.php?con=adv&fun=adv_drop&adv_id=__IDS__'.replace('__IDS__', ids.join(','));
                    } }
               ]
		});
...
function fg_operation(name, bDiv) {
    if (name == 'add') {
        window.location.href = 'index.php?con=adv&fun=adv_add';
    }
}
</script>