...
<script>
$(function() {
    var flexUrl = 'index.php?con=goods&fun=goods_manage_xml';
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    location.href = 'index.php?con=goods&fun=goods_drop&commend_id=__IDS__'.replace('__IDS__', ids.join(','));
                }
            }
        ],
        searchitems: [
...
$('a[data-ie-column]').live('click', function() {
    $.get('index.php?con=goods&fun=ajax&branch=goods_commend', {
...
$("span[data-live-inline-edit='microshop_sort']").live('click', function() {
    ...
    $input.change(function() {
        ...
        $.getJSON('index.php?con=goods&fun=goods_sort_update', {
            id: $this.parents('tr').attr('data-id'),
            value: v2
        }, function(d) {
            if (d.result) {
