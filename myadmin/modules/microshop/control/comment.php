...
class commentControl extends SystemControl{
    ...
    public function comment_manage_xmlOp()
    {
        ...
        foreach ($list as $val) {
            ...
            $o = '<a class="btn red confirm-del-on-click" href="index.php?con=comment&fun=comment_drop&comment_id=' .
                    $val['comment_id'] .
                    '"><i class="fa fa-trash"></i>删除</a>';

            $o .= '<a class="btn green" target="_blank" href="' .
                MICROSHOP_SITE_URL.DS.'index.php?con=' .
                $channel['key'] .
                '&fun=detail&' .
                $channel['key'] .
                '_id=' .
            ...
            $i['member_name'] = '<a href="' .
                MICROSHOP_SITE_URL.DS.'index.php?con=home&member_id=' .
