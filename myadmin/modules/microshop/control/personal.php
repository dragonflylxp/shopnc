...
class personalControl extends SystemControl{
    ...
    public function personal_manage_xmlOp()
    {
        ...
        foreach ($list as $val) {
            $o = '<a class="btn red confirm-del-on-click" href="index.php?con=personal&fun=personal_drop&personal_id=' .
                $val['personal_id'] .
            ...
            $u = MICROSHOP_SITE_URL.DS.'index.php?con=personal&fun=detail&personal_id=' . $val['personal_id'];
...
EOB;
            ...
            $i['member_name'] = '<a href="' .
                MICROSHOP_SITE_URL.DS.'index.php?con=home&member_id=' . $val['commend_member_id'] .
                '" target="_blank">' .
                $val['member_name'] .
                '</a>';
