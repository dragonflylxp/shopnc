...
class storeControl extends SystemControl{
    ...
    public function store_manage_xmlOp()
    {
        ...
        foreach ($list as $val) {
            $o = '<a class="btn red confirm-del-on-click" href="index.php?con=store&fun=store_drop_save&store_id=' .
                $val['store_id'] .
            ...
            $i['store_name'] = '<a target="_blank" href="' .
                ...
                'index.php?con=store&fun=detail&store_id=' .
                $val['store_id'] .
                '">' .
                $val['store_name'] .
                '</a>';
    ...
    public function store_add_xmlOp()
    {
        ...
        foreach ($list as $val) {
            ...
            if ($addedState) {
                ...
                $o = '<a class="btn green" href="index.php?con=store&fun=store_add_save&store_id=' .
                    $val['store_id'] .
    ...
    private function show_menu_store($menu_key) {
        $menu_array = array(
                'store_manage'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_manage'),'menu_url'=>'index.php?con=store&fun=store_manage'),
                'store_add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?con=store&fun=store_add'),
        );
