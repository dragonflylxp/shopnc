...
class advControl extends SystemControl{
    ...
    public function adv_saveOp() {
        ...
        if($result) {
            showMessage(Language::get('nc_common_save_succ'),"index.php?con=adv&fun=adv_manage");
        } else {
            showMessage(Language::get('nc_common_save_fail'),"index.php?con=adv&fun=adv_manage",'','error');
        }
    }
    ...
    private function show_menu_adv($menu_key) {
        $menu_array = array(
            'adv_manage'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_manage'),'menu_url'=>'index.php?con=adv&fun=adv_manage'),
            'adv_add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?con=adv&fun=adv_add'),
        );
