...
class goods_classControl extends SystemControl{
    ...
    public function goodsclass_saveOp() {
        ...
        if($result) {
            showMessage(Language::get('class_add_success'),"index.php?con=goods_class&fun=goodsclass_list");
        } else {
            showMessage(Language::get('class_add_fail'),"index.php?con=goods_class&fun=goodsclass_list",'','error');
        }
    ...
    private function show_menu_goods_class($menu_key) {
        $menu_array = array(
                'goods_class_list'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_manage'),'menu_url'=>'index.php?con=goods_class&fun=goodsclass_list'),
                'goods_class_add'=>array('menu_type'=>'link','menu_name'=>Language::get('nc_new'),'menu_url'=>'index.php?con=goods_class&fun=goodsclass_add'),
        );
