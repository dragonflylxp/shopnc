...
class goodsControl extends SystemControl{
    ...
    public function goods_manage_xmlOp()
    {
        ...
        foreach ($list as $val) {
            $o = '<a class="btn red confirm-del-on-click" href="index.php?con=goods&fun=goods_drop&commend_id=' .
                $val['commend_id'] .
            ...
            $o .= '<li><a target="_blank" href="' .
                    MICROSHOP_SITE_URL.DS.'index.php?con=goods&fun=detail&goods_id=' .
                    $val['commend_id'] .
                    '">查看商品</a></li>';
