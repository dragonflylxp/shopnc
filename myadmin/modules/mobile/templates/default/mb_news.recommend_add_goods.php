<div class="div-goods-select">
    <table class="search-form">
        ...
        <tr>
            ...
            <td class="tc w70"><a href="index.php?con=mb_news&fun=recommend_add_goods" nctype="search_a" class="ncs-btn"><i class="icon-search"></i><?php echo $lang['nc_search'];?></a></td>
            <td class="w10"></td>
        </tr>
        </tbody>
    </table>
            ...
            <ul class="goods-list" nctype="recommend_goods_add_tbody" style=" width:760px;">
                <?php foreach ($output['goods_list'] as $val){?>
                    <li nctype="<?php echo $val['goods_commonid'];?>">
                        ...
                        <dl class="goods-info">
                            <dt>
                                <a href="<?php echo urlShop('goods', 'index', array('goods_id' => $val['goods_commonid']))?>" target="_blank" title="<?php echo '商品名称/';?><?php echo $val['goods_name'];?>"><?php echo $val['goods_name'];?>
                                </a>
                            </dt>
