...
<div class="page">
  ...
  <form id="post_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"> <a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['nc_submit'];?></a><a href="javascript:;"  class="ncap-btn-big ncap-btn-orange ml10">生成二维码</a> </div>
    </div>
  </form>
</div>
<script>
...
$(document).ready(function(){
    ...
    $(function(){
        $('.ncap-btn-big').on('click',function(){
            var mobile_apk = $('#mobile_apk').val();
            var mobile_ios = $('#mobile_ios').val();
            if(mobile_apk!='' || mobile_ios != ''){
                var data = {mobile_apk:mobile_apk,mobile_ios:mobile_ios};
                $.ajax({
                    type:'post',
                    url:"index.php?con=mb_app&fun=mb_and_ap_qr",
                    dataType:'json',
                    data:data,
