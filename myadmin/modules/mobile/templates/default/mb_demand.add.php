...
.input-file-show .type-file-box .err2{ position: absolute; width: 160px}
.ncsc-form-radio-list .err3{ position:relative; width: 160px;top:-50px; left: 210px}
                    ...
                    <ul class="ncsc-form-radio-list">
                        ...
                        <li>
                            ...
                            <div nctype="div_promote" style="display: none;">
                                <div class="input-file-show">
                                    <span class="type-file-box">
                                        <input name="promote_image" type="file" class="type-file-file" id="promote_image" size="30" hidefocus="true">
                                        <span class="err2"></span>
                                    </span>
                                </div>
