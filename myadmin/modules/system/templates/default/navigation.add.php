    ...
    <form id="navigation_form" method="post">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="is_nav_add1" class="cb-enable selected"><?php echo $lang['nc_yes']; ?></label>
                        <label for="is_nav_add0" class="cb-disable"><?php echo $lang['nc_no']; ?></label>
                        <input id="is_nav_add1" name="is_nav_add" checked="checked" value="1" type="radio">
                        <input id="is_nav_add0" name="is_nav_add" value="0" type="radio">
                    </div>
                    <p class="notic"></p>
                </dd>
            </dl>
