...
$(function(){
    $("#flexigrid").flexigrid({
      ...
      {display: '热门地区', name : 'hot_area', width : 50, sortable : false, align: 'left'},
      {display: '排序', name : 'area_sort', width : 50, sortable : false, align: 'left'}            
...
function fg_show_children(area_id,parent_id) {
	$("#flexigrid").flexOptions({url: 'index.php?con=area&fun=get_xml&parent_id='+area_id,query:'',qtype:''}).flexReload();
