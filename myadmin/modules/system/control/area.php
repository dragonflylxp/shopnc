...
class areaControl extends SystemControl{
    ...
    public function get_xmlOp() {
        ...
        foreach ($list as $k => $info) {
             ...
             * by0114
             */
            $list['first_letter'] = $info['first_letter'];
            $list['hot_area'] = $info['hot_area'];
            $list['area_sort'] = $info['area_sort'];            
    ...
    public function saveOp() {
        ...
        $data['area_sort'] = $_POST['area_sort'];
        $data['hot_area'] = empty($_POST['hot_area']) ? 0 : $_POST['hot_area'];        
        if ($_GET['area_id']) {
