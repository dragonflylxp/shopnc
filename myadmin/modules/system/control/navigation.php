    ...
    public function navigation_addOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                $insert_array['is_nav_add'] = trim($_POST['is_nav_add']) ? trim($_POST['is_nav_add']) : '0';
    ...
    public function navigation_editOp(){
        ...
        if (chksubmit()){
            ...
            if ($error != ''){
                ...
                /*-------判断是否加在导航首页两个字的后面 start liming------*/
                    $update_array['is_nav_add'] = trim($_POST['is_nav_add']) ? trim($_POST['is_nav_add']) : '0';
                /*-------判断是否加在导航首页两个字的后面 end liming------*/
