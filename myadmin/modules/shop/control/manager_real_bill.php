...
class manager_real_billControl extends SystemControl{
    ...
    {
        Tpl::showpage('manager_real_bill.index');
    }
    ...
    public function index_xmlOp()
    {
        ...
        foreach ($list as $val) {
            ...
            $i['operation'] =  <<<EOB
<a class="btn green confirm-del-on-click" href="index.php?con=manager_real_bill&fun=show_manager_real_bill&member_id={$val['uid']}" ><i class='fa fa-pencil-square-o'></i>查看</a>
EOB;
...
EOB;
    ...
    public function show_manager_real_billOp(){
        ...
        Tpl::showpage('manager_real_bill.show');
    }
...
//            取得开始和结束日期
        ...
        if (!is_numeric($_GET['curpage'])) {
            ...
            if ($count > self::EXPORT_SIZE) {
                ...
                Tpl::output('murl', 'index.php?con=manager_real_bill&fun=index');
