...
<script>
    ...
    $(function() {
        var flexUrl = 'index.php?con=manager_vrbill_check&fun=get_index_xml';
            ...
            buttons: [
                {
                    ...
                    onpress: function() {
                        ...
                        location.href = qs+'&con=manager_vrbill_check&fun=export_step2&ids=' + ids.join(',');
                    }
                }
            ],
            searchitems: [
