...
<div class="page">
    ...
    <div class="ncap-form-default">
        ...
        <form id="form_store_verify" action="index.php?con=manager_rebill_check&fun=bill_state_verify" method="post">
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                    ...
                    <tr>
                        ...
                        <td> <input type="text"  <?php
                            ...
                            ?> id="pay_date" name="pay_date" value="<?php
            ...
            <?php if(in_array(intval($output['bill_info']['state']), array(3))) { ?>
                ...
                <div class="bottom"><a id="btn_pass" class="ncap-btn-big ncap-btn-green mr10" href="JavaScript:void(0);">已打款</a><a id="btn_fail" class="ncap-btn-big ncap-btn-red" href="index.php?con=manager_rebill_check&fun=get_money_state">取消</a> </div>
            <?php } ?>
        </form>
    </div>
...
//        $('a[nctype="nyroModal"]').nyroModal();
        ...
        $('#btn_pass').on('click', function() {
            if($('#pay_date').val() == '') {
                $('#validation_message').text('请输入付款时间');
