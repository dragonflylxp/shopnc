...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            <a class="back" href="index.php?con=manager_real_bill&fun=index" title="返回地区管理人列表"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3>管理人结算详细信息</h3>
    ...
    <div class="ncap-form-default">
        <h2>管理人个人信息</h2>
<!--        <dl class="row">-->
<!--            <dt class="tit">管理人账号</dt>-->
<!--            <dd class="opt">--><?php //echo $output['bill_info']['manager_account'];?><!--</dd>-->
<!--        </dl>-->
        <dl class="row">
