    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a class="current" href="JavaScript:void(0);">虚拟结算管理</a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
            ...
            <div id="searchCon" class="content">
                <div class="layout-box">
                    <dl>
                        <dt>账单ID</dt>
                        <dd>
                            <input type="text" value="" name="member_ob_id" id="ob_id" class="s-input-txt">
                        </dd>
                    </dl>
                    <dl>
                        <dt>会员ID</dt>
                        <dd>
                            <label><input type="text" value="" name="member_ob_member_id" id="ob_store_name" class="s-input-txt"></label>
                        </dd>
                    </dl>
                    <dl>
                        <dt>结算状态</dt>
...
<script type="text/javascript">
    $(function(){
        ...
        $('#ncsubmit').click(function(){
            $("#flexigrid").flexOptions({url: 'index.php?con=member_virtual_bill&fun=get_virtual_bill_xml&'+$("#formSearch").serialize(),query:'',qtype:''}).flexReload();
        });

        // 高级搜索重置
        $('#ncreset').click(function(){
            $("#flexigrid").flexOptions({url: 'index.php?con=member_virtual_bill&fun=get_virtual_bill_xml'}).flexReload();
            $("#formSearch")[0].reset();
        });
        $("#flexigrid").flexigrid({
            url: 'index.php?con=member_virtual_bill&fun=get_virtual_bill_xml',
            colModel : [
