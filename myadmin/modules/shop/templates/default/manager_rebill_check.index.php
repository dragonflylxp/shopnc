...
<div class="page">
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            ...
            <li>点击查看按钮可以查看未通过的管理人提现申请信息</li>
            <li>点击审核按钮可以对管理人提交申请的信息进行审核</li>
        </ul>
    </div>
...
<script>
    ...
    $(function() {
        var flexUrl = 'index.php?con=manager_rebill_check&fun=index_xml';
        ...
        $("#flexigrid").flexigrid({
            ...
            colModel: [
                ...
                {display: '审核状态', name : 'state', width : 120, sortable : true, align: 'center'}
            ],
            buttons: [
                {
                    ...
                    onpress: function() {
                        ...
                        location.href = qs+'&con=manager_rebill_check&fun=export_step1&ids=' + ids.join(',');
                    }
                }
            ],
            searchitems: [
