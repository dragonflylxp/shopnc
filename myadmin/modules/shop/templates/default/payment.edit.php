...
<div class="page">
  ...
  <form id="post_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <?php } elseif ($output['payment']['payment_code'] == 'offbank') { ?>
      <dl class="row">
        <dt class="tit">卡号</dt>
        <dd class="opt">
        <input type="hidden" name="config_name" value="id_code,company_name,bank_name,bank_branch" />
          <input name="id_code" id="id_code" value="<?php echo $output['config_array']['id_code'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">公司名</dt>
        <dd class="opt">
          <input name="company_name" id="company_name" value="<?php echo $output['config_array']['company_name'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">开户行</dt>
        <dd class="opt">
          <input name="bank_name" id="bank_name" value="<?php echo $output['config_array']['bank_name'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">支行</dt>
        <dd class="opt">
          <input name="bank_branch" id="bank_branch" value="<?php echo $output['config_array']['bank_branch'];?>" class="input-txt" type="text">
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
      </dl>
      ...
      <?php }elseif ($output['payment']['payment_code'] == 'fastpay') { ?>
          ...
          <dl class="row">
              <dt class="tit">APP_KEY</dt>
              <dd class="opt">
                  <input type="hidden" name="config_name" value="appid,secret,customno" />
                  <input name="appid" id="appid" value="<?php echo $output['config_array']['appid'];?>" class="input-txt" type="text">
                  <span class="err"></span>
                  <p class="notic">系统分配给应用的App_Key</p>
              </dd>
          </dl>
          <dl class="row">
              <dt class="tit">APP_SECRET</dt>
              <dd class="opt">
                  <input name="secret" id="secret" value="<?php echo $output['config_array']['secret'];?>" class="input-txt" type="text">
                  <span class="err"></span>
                  <p class="notic">系统分配给应用的APP_SECRET</p>
              </dd>
          </dl>
          <dl class="row">
              <dt class="tit">客户号</dt>
              <dd class="opt">
                  <input name="customno" id="customNo" value="<?php echo $output['config_array']['customno'];?>" class="input-txt" type="text">
                  <span class="err"></span>
                </dd>
          </dl>
