    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        <div class="misc-info">
          ...
          <?php } else if ($output['order_info']['payment_code'] == 'offline'|| $output['order_info']['payment_code'] == 'offbank') { ?>
            <dl>
              <dt><?php echo $lang['payment'];?><?php echo $lang['nc_colon'];?></dt>
              <dd><?php echo orderPaymentName($output['order_info']['payment_code']);?></dd>
            </dl>
          ...
          <?php if ($output['order_info']['order_state'] == ORDER_STATE_PAY) { ?>
            <dl>
              <dt>支付日志：</dt>
              <dd>管理员 收到货款(外部交易号:<?php echo $output['order_info']['trade_no'];?>)</dd>
            </dl>
          <?php }?>
        </div>
        <div class="addr-note">
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td class="w80"><?php echo $output['order_info']['commis_rate'] == 200 ? '' : ncPriceFormat($output['order_info']['goods_price']*$output['order_info']['goods_num']*$output['order_info']['commis_rate']/100);?></td>
              </tr>
            </tbody>
          </table>
        </div>
