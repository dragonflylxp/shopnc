...
<div class="page">
  ...
  <div class="ncap-form-default">
    ...
    <dl class="row">
      <dt class="tit">结算银行开户名</dt>
      <dd class="opt"><?php echo $output['bill_bank_info']['settlement_bank_account_name'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit">结算公司银行账号</dt>
      <dd class="opt"><?php echo $output['bill_bank_info']['settlement_bank_account_number'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit">结算开户银行支行名称</dt>
      <dd class="opt"><?php echo $output['bill_bank_info']['settlement_bank_name'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit">结算支行联行号</dt>
      <dd class="opt"><?php echo $output['bill_bank_info']['settlement_bank_code'];?></dd>
    </dl>
    <dl class="row">
      <dt class="tit">结算开户银行所在地</dt>
      <dd class="opt"><?php echo $output['bill_bank_info']['settlement_bank_address'];?></dd>
    </dl>
