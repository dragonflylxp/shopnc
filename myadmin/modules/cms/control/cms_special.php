...
class cms_specialControl extends SystemControl{
        ...
        if (!empty($list) && is_array($list)){
            ...
            foreach ($list as $k => $v){
                ...
                if($v['special_state'] == '2') {
                    ...
                    $operation .= '<li><a href="index.php?con=cms_special&fun=cms_special_detail&special_id='.$v['special_id'].'" target="_blank">预览专题页面</a></li>';
                }
                $operation .= '<li><a href="index.php?con=cms_special&fun=cms_special_edit&special_id='.$v['special_id'].'">编辑专题内容</a></li>';
                $operation .= '</ul></span>';
 ...
 /*  public function cms_special_addOp() {
        ...
        Tpl::showpage('cms_special.add_test');
    }*/
    ...
    public function cms_special_saveOp() {
        ...
        $param['special_html'] = $_POST['special_html'];
