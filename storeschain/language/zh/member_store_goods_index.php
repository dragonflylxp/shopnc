 ...
 * index
 */
$lang['store_goods_index_store_close']	 		= '您的店鋪已關閉';
...
$lang['store_goods_close_reason_des']			= '分類或規格資訊不符';
...
$lang['store_goods_index_goods_limit1']			= '個，如果您想繼續增加商品，請到“店鋪設置”升級店鋪等級';
$lang['store_goods_index_pic_limit']			= '您已經達到了圖片空間的上限';
$lang['store_goods_index_pic_limit1']			= 'M，如果您想繼續增加商品，請到“店鋪設置”升級店鋪等級';
$lang['store_goods_index_time_limit']			= '您已經達到店鋪使用期限，如果您想繼續增加商品，請到“店鋪設置”升級店鋪等級';
$lang['store_goods_index_no_pay_type']			= '平臺還未設置支付方式，請及時與平臺聯繫';
...
$lang['store_goods_index_belong_multiple_store_class']	= '商品可以從屬於店鋪的多個分類之下，店鋪分類可以由 "商家中心 -> 店鋪 -> 店鋪分類" 中自定義';
$lang['store_goods_index_goods_base_info']		= '商品基本資訊';
$lang['store_goods_index_goods_detail_info']	= '商品詳情描述';
$lang['store_goods_index_goods_transport']		= '商品物流資訊';
$lang['store_goods_index_goods_szd']			= '所在地';
$lang['store_goods_index_use_tpl']				= '選擇售賣區域';
$lang['store_goods_index_select_tpl']			= '選擇售賣區域';
$lang['store_goods_index_goods_other_info']		= '其他資訊';
$lang['store_goods_index_upload_goods_pic']		= '上傳商品圖片';
$lang['store_goods_index_remote_url']			= '遠程地址';
$lang['store_goods_index_remote_tip']			= '支持JPEG和靜態的GIF格式圖片，不支持GIF動畫圖片，上傳圖片大小不能超過2M.流覽檔時可以按住ctrl或shift鍵多選';
$lang['store_goods_index_goods_brand']			= '商品品牌';
$lang['store_goods_index_multiple_tag']			= '多個Tag標籤請用半角逗號 "," 隔開';
$lang['store_goods_index_store_price']			= '商品價格';
$lang['store_goods_index_store_price_help']		= '價格必須是0.01~9999999之間的數字';
$lang['store_goods_index_goods_stock']			= '商品庫存';
$lang['store_goods_index_goods_stock_checking']	= '商鋪庫存數量必須為0~999999999之間的整數';
$lang['store_goods_index_goods_stock_help']		= '商鋪庫存數量必須為0~999999999之間的整數<br/>若啟用了庫存配置，則系統自動計算商品的總數，此處無需賣家填寫';
...
$lang['store_goods_index_goods_select_tpl']		= '請選擇要使用的運費範本';
...
$lang['store_goods_index_goods_no']				= '商家貨號';
$lang['store_goods_index_goods_no_help']		= '商家貨號是指商家管理商品的編號，買家不可見<br/>最多可輸入20個字元，支持輸入中文、字母、數字、_、/、-和小數點';
...
$lang['store_goods_index_recommend_tip']		= '被推薦的商品會顯示在店鋪首頁';
...
$lang['store_goods_index_goods_seo_keywords_help']		= 'SEO關鍵字 (keywords) 出現在商品詳細頁面頭部的 Meta 標籤中，<br/>用於記錄本頁面商品的關鍵字，多個關鍵字間請用半角逗號 "," 隔開';
...
$lang['store_goods_step2_description_one']				= '上傳商品默認主圖，如多規格值時將默認使用該圖或分規格上傳各規格主圖；支持jpg、gif、png格式上傳或從圖片空間中選擇，建議使用<font color="red">尺寸800x800像素以上、大小不超過1M的正方形圖片</font>，上傳後的圖片將會自動保存在圖片空間的默認分類中。';

$lang['store_goods_album_climit']						= '您上傳圖片數達到上限，請升級您的店鋪或跟管理員聯繫';
/**
 * 商品發佈第一步
 */
...
$lang['store_goods_step3_viewed_product']				= '去店鋪查看商品詳情';
...
$lang['store_goods_brand_icon']					= '品牌圖示';
...
$lang['store_goods_brand_icon_null']			= '請上傳品牌圖示';
...
$lang['store_goods_brand_browse']				= '流覽...';
/**
 * 圖片上傳
 */
$lang['store_goods_upload_pic_limit']			= '您已經達到了圖片空間的上限';
$lang['store_goods_upload_pic_limit1']			= 'M，如果您想繼續增加商品，請到“店鋪設置”升級店鋪等級';
 ...
 * 淘寶導入
 */
$lang['store_goods_import_choose_file']		= '請選擇要上傳csv的檔';
$lang['store_goods_import_unknown_file']	= '檔來源不明';
$lang['store_goods_import_wrong_type']		= '檔類型必須為csv,您所上傳的檔類型為:';
$lang['store_goods_import_size_limit']		= '檔大小必須為'.ini_get('upload_max_filesize').'以內';
...
$lang['store_goods_import_wrong_column']	= '檔內字段與系統要求的字段不符,請詳細閱讀導入說明';
$lang['store_goods_import_choose']			= '請選擇...';
$lang['store_goods_import_step1']			= '第一步：導入CSV檔';
$lang['store_goods_import_choose_csv']		= '請選擇檔：';
$lang['store_goods_import_title_csv']		= '導入程式默認從第二行執行導入，請保留CSV檔第一行的標題行，最大'.ini_get('upload_max_filesize');
...
$lang['store_goods_import_file_type']		= '檔格式：';
$lang['store_goods_import_file_csv']		= 'csv檔';
$lang['store_goods_import_desc']			= '導入說明：';
$lang['store_goods_import_csv_desc']		= '1.如果修改CSV檔請務必使用微軟excel軟體，且必須保證第一行表頭名稱含有如下專案: 
...
3.如果CSV檔超過'.ini_get('upload_max_filesize').'請通過excel軟體編輯拆成多個檔進行導入。<br/>
4.每個商品最多支持導入5張圖片。';
$lang['store_goods_import_submit']			= '導入';
$lang['store_goods_import_step2']			= '第二步：上傳商品圖片';
$lang['store_goods_import_tbi_desc']		= '請上傳與csv檔同級的images目錄(或與csv檔同名的目錄)內的tbi檔';
...
$lang['store_goods_pack_wrong1']			= '請先導入CSV檔';
$lang['store_goods_pack_wrong2']			= '請導入正確的CSV檔';
...
$lang['store_goods_stock_change_more_stock']= '修改更多的庫存資訊';
...
$lang['store_goods_price_change_more_price']= '修改更多價格資訊';
$lang['store_goods_price_input_error']		= '請填寫正確的價格！';

/**
 * ajax修改商品推薦
 */
$lang['store_goods_commend_change_tip']		= '選擇是否作為店鋪推薦商品';
