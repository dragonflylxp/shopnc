...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    ...
    <ul class="ncsc-nav">
      <li> <a href="index.php?con=goods" class="<?php echo $_GET['con'] == 'goods'?'current':'';?>">门店商品库存</a> </li>
      <li> <a href="index.php?con=order" class="<?php echo $_GET['con'] == 'order'?'current':'';?>">门店取货订单</a> </li>
