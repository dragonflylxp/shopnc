...
<script>
    $(function(){
        $('.pay_name').live('change',function(){
            var pay_name=$("input[name='pay_name']:checked").val();
            $('#pay_name').val(pay_name);
            if(pay_name == 'dhq'){
                $('.vo_card').css('display','none');
                $('.pd-account').css('display','none');
            }else if(pay_name == 'online'){
                $('.vo_card').css('display','block');
                $('.pd-account').css('display','');
            }
        })
    })
</script>
