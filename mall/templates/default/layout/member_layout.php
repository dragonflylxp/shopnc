            ...
            <div class="ncm-member-info">
                <div class="avatar"><a href="<?php echo urlMember('member_information', 'avatar'); ?>" title="修改头像"><img
                    ...
                    <?php if (intval($output['message_num']) > 0) { ?>
                        <a href="<?php echo MEMBER_SITE_URL ?>/index.php?con=member_message&fun=message"
            ...
            <ul class="nav-menu">
                ...
                <li class="set"><a href="<?php echo urlMember('member', 'home'); ?>">用户设置<i></i></a>
                    ...
                    <div class="sub-menu">
                        ...
                        <dl>
                            ...
                            <dd><a href="<?php echo urlMember('member_banks', 'banks'); ?>">我的银行卡</a></dd>
                ...
                <?php if (C('distribute_isuse') && in_array($output['member_info']['distri_state'], array(2, 4, 5)) && $output['member_info']['distri_show'] == 1) { ?>
                    <li class="distri"><a href="<?php echo urlDistribute('distri_center', 'home'); ?>">分销中心<i></i></a>
                        ...
                        <div class="sub-menu">
                            <dl>
                                <dt><a href="<?php echo urlDistribute('distri_goods', 'goods_list'); ?>"
                                       style="color: #398EE8;">分销管理</a></dt>
                            ...
                            <dl>
                                <dt><a href="<?php echo urlDistribute('access_infomation', 'member') ?>"
                                       style="color: #3AAC8A">财产中心</a></dt>
                        ...
                        <?php if (!empty($value['child'])) { ?>
                            <ul <?php if (cookie('Mmenu_' . $key) == 1) echo 'style="display:none"'; ?>>
                                <?php foreach ($value['child'] as $key => $val) { ?>
                                    <li <?php if ($key == $output['con']) { ?>class="selected"<?php } ?>><a
