  ...
  <div class="ncsl-nav">
    ...
    <div id="nav" class="ncs-nav">
      <ul>
        ...
        <!--511613932-->
                <li class="<?php if($output['page'] == 'zhibo'){?>active<?php }else{?>normal<?php }?>"><a href="<?php echo urlShop('show_zhibo', 'index', array('store_id'=>$output['store_info']['store_id']));?>"><span>店内直播<i></i></span></a></li>
