    ...
    <div class="variation">
      <div class="middle">
        ...
        <div class="user-login-box" nctype="barLoginBox" style="display:none;"> <i class="arrow"></i> <a href="javascript:void(0);" class="close-a" nctype="close-barLoginBox" title="关闭">X</a>
          <form id="login_form" method="post" action="index.php?con=login&fun=login" onsubmit="ajaxpost('login_form', '', '', 'onerror')">
            ...
            <div class="bottom">
              ...
              <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=connect_sina" title="新浪微博账号登录" class="mr20">新浪微博</a>
              <?php } ?>
              <?php if (C('qq_isuse') == 1){?>
              <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=connect_qq" title="QQ账号登录" class="mr20">QQ账号</a>
              <?php } ?>
            </div>
          </form>
        </div>
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="user-entry">
      ...
      <?php }?>
      <span style="margin-left:10px;"><a href="index.php?con=invite" style="color:#0094DE;">邀请返利</a></span> <!--20160904-->
    </div>
