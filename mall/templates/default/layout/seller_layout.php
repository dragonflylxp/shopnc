  ...
  <div class="wrapper">
    ...
    <nav class="ncsc-nav">
      ...
      <dl class="<?php echo $output['current_menu']['model'] == $key?'current':'';?>">
        <dt><a href="<?php echo $key != 'distribute' ? '':DISTRIBUTE_SITE_URL.'/';?>index.php?con=<?php echo $menu_value['child'][key($menu_value['child'])]['con'];?>&fun=<?php echo $menu_value['child'][key($menu_value['child'])]['fun'];?>"><?php echo $menu_value['name'];?></a></dt>
        <dd>
          <ul>
            <?php if(!empty($menu_value['child']) && is_array($menu_value['child'])) {?>
            <?php foreach($menu_value['child'] as $submenu_value) {?>
            <li> <a href="<?php echo $key != 'distribute' ? '':DISTRIBUTE_SITE_URL.'/';?>index.php?con=<?php echo $submenu_value['con'];?>&fun=<?php echo $submenu_value['fun'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
            <?php } ?>
            <?php } ?>
          </ul>
        </dd>
    ...
    <div id="sidebar" class="sidebar">
      ...
      <div class="column-menu">
        <ul id="seller_center_left_menu">
          ...
          <li <?php echo $_GET['con'] == 'seller_center'?"id='quicklink_".$submenu_value['con']."'":'';?>class="<?php echo $submenu_value['con'] == $_GET['con']?'current':'';?>"> 
            <a href="<?php echo strpos($submenu_value['con'],'store_dis_')===0 ? DISTRIBUTE_SITE_URL.'/':'';?>index.php?con=<?php echo $submenu_value['con'];?>&fun=<?php echo $submenu_value['fun'];?>"> <?php echo $submenu_value['name'];?> </a> </li>
          <?php } ?>
          <?php } else { ?>
