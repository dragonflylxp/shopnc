    ...
    <ul class="menu">
      ...
      <li><a href="javascript:void(0)" class="my-friend"><?php echo $lang['sns_my_attention'];?><i></i></a>
        <div class="friend-menu">
          ...
          <p>
            <?php if(!empty($output['my_attention'])){?>
            <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=member_snsfriend&fun=follow"><?php echo $lang['sns_attention_more'];?></a>
            <?php }else{?>
            <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=member_snsfriend&fun=find"><?php echo $lang['sns_search_friend'];?></a>
            <?php }?>
          </p>
        </div>
      </li>
