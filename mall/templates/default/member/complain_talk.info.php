...
<h3><?php echo $lang['talk_detail'];?></h3>
  ...
  <form action="index.php?con=member_complain&fun=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?con=member_complain&fun=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?con=member_complain&fun=publish_complain_talk',
                cache:false,
