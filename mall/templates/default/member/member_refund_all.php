      ...
      <div class=" ncm-default-form">
        ...
        <form id="post_form1" enctype="multipart/form-data" method="post" action="index.php?con=member_refund&fun=add_refund_all&order_id=<?php echo $output['order']['order_id']; ?>&goods_id=<?php echo $output['goods']['rec_id']; ?>">
          ...
          <dl>
            ...
            <dd><strong class="green"><?php echo ncPriceFormat($output['order']['allow_refund_amount']); ?></strong> 元
                <?php if($output['payType']['payment_code']=='dhq'){;?>
                <?php echo "<span style='color: #FD6760;font-weight: 600'>(该笔订单是使用兑换卷兑换的,无法退款及退货!)</span>"?>
                <?php };?>
            </dd>
          </dl>
          <dl>
          ...
          <div class="bottom">
            <label class="submit-border">
              <input type="submit" class="submit" value="确认提交" <?php if($output['payType']['payment_code']=='dhq'){ echo "disabled=disabled";};?>
              style="<?php if($output['payType']['payment_code']=='dhq'){ echo "background-color:#CCD0D9;color:#FFF";};?>"
              />
            </label>
