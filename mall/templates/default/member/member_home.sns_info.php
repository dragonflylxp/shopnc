    ...
    <div class="outline">
      ...
      <?php if (!empty($output['follow_list']) && is_array($output['follow_list'])) { ?>
       <div class="ncm-friends-share">
            ...
            <div class="more"><a target="_blank" href="<?php echo MEMBER_SITE_URL;?>/index.php?con=member_snsfriend&fun=follow">查看我的全部好友</a></div>
          </div>
     <?php } else { ?>
      <dl class="null-tip">
        <dt></dt>
        <dd>
          ...
          <p><a target="_blank" href="<?php echo MEMBER_SITE_URL;?>/index.php?con=member_snsfriend&fun=follow" class="ncbtn-mini" >查看我的全部好友</a></p>
        </dd>
      </dl>
    <?php } ?>  
    </div>
