...
$(function(){
	...
	$.getJSON('index.php?con=member_order&fun=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
		if(data){
			data = data.join('<br/>');
