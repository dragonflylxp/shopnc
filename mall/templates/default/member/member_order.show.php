...
function save_sn(){
  ...
  $.getJSON('index.php?con=member_order&fun=ajaxSaveTradeNo&trade_no='+trade_no+'&order_id='+<?php echo $output['order_info']['order_id'];?>,function(data){
    if(data){
        location.reload();
    }else{
        alert("修改失败");
...
function save_sn_name(){
  ...
  $.getJSON('index.php?con=member_order&fun=ajaxSaveTradeNoName&trade_no_name='+trade_no_name+'&order_id='+<?php echo $output['order_info']['order_id'];?>,function(data){
    if(data){
      location.reload();
    }else{
      alert("修改失败");
