  ...
  <form id="form_credentials_info" action="index.php?con=store_joinin&fun=step3" method="post" >
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i>支行联行号：</th>
          <td><input name="bank_code" type="text" class="w200" value="<?php echo $output['store_info']['bank_code']; ?>" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>开户银行所在地：</th>
    ...
    <div id="div_settlement">
      <table border="0" cellpadding="0" cellspacing="0" class="all">
        ...
        <tbody>
          ...
          <tr>
            <th><i>*</i>支行联行号：</th>
            <td><input id="settlement_bank_code" name="settlement_bank_code" value="<?php echo $output['store_info']['settlement_bank_code']; ?>" type="text" class="w200"/>
              <span></span></td>
          </tr>
          <tr>
            <th><i>*</i>开户银行所在地：</th>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i>纳税人识别号：</th>
          <td><input name="taxpayer_id" type="text" class="w200" value="<?php echo $output['store_info']['taxpayer_id']; ?>" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>税务登记证号电子版：</th>
...
$(document).ready(function(){
    ...
    $("#is_settlement_account").on("click", function() {
        if($(this).prop("checked")) {
            ...
            $("#settlement_bank_code").val("<?php echo $output['store_info']['settlement_bank_code']; ?>");
