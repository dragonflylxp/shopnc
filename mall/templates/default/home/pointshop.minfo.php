...
<div class="ncp-member-point">
  <dl style="border-left: none 0;">
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=member_points" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=member_voucher&fun=index" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=member_pointorder&fun=orderlist" target="_blank">
