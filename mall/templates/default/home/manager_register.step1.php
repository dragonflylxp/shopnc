...
<div id="apply_credentials_info" class="apply-credentials-info">
  <div class="alert">
    ...
    ?>
  <form id="form_credentials_info" action="index.php?con=manager_register&fun=step2" method="post" >
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        ...
        <tr>
          <th><i>*</i>公司银行账号：</th>
          <td><input name="bank_account_number" type="text" value="<?php echo _decrypt($output['store_info']['bank_account_number']); ?>" class="w200" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>开户银行支行名称：</th>
        ...
        <tr>
          <th><i>*</i>支行联行号：</th>
          <td><input name="bank_code" type="text" class="w200" value="<?php echo _decrypt($output['store_info']['bank_code']); ?>" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>开户银行所在地：</th>
          <td><input id="bank_address" name="bank_address" type="hidden" value="<?php echo $output['store_info']['bank_address']; ?>" />
            <span></span></td>
        </tr>
        <tr>
          ...
          <td><input name="bank_licence_electronic" type="file"  class="w60"/>
              <?php
              if(!empty($output['store_info']['bank_licence_electronic'])){
                  $htm = '<img height="60" src="';
                  $htm .= $output['pic_url'].$output['store_info']['bank_licence_electronic'];
                  $htm .='"/>';
                  echo $htm;
              }
              ?>
            <span class="block">请确保图片清晰，文字可辨并有清晰的红色公章。</span>
            <input name="bank_licence_electronic1" value="<?php echo $output['store_info']['bank_licence_electronic']; ?>" type="hidden"/>
            <span></span>
            </td>
        </tr>
        <tr>
    ...
    <div id="div_settlement">
      <table border="0" cellpadding="0" cellspacing="0" class="all">
        ...
        <tbody>
          ...
          <tr>
            <th><i>*</i>公司银行账号：</th>
            <td><input id="settlement_bank_account_number" name="settlement_bank_account_number" value="<?php echo _decrypt($output['store_info']['settlement_bank_account_number']); ?>" type="text" class="w200"/>
              <span></span></td>
          </tr>
          <tr>
            <th><i>*</i>开户银行支行名称：</th>
          ...
          <tr>
            <th><i>*</i>支行联行号：</th>
            <td><input id="settlement_bank_code" name="settlement_bank_code" value="<?php echo _decrypt($output['store_info']['settlement_bank_code']); ?>" type="text" class="w200"/>
              <span></span></td>
          </tr>
          <tr>
            <th><i>*</i>开户银行所在地：</th>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      ...
      <tbody>
        <tr>
          ...
          <td><input name="tax_registration_certificate"  value="<?php echo _decrypt($output['store_info']['tax_registration_certificate']); ?>"  type="text" class="w200"/>
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>纳税人识别号：</th>
          <td><input name="taxpayer_id" type="text" class="w200" value="<?php echo _decrypt($output['store_info']['taxpayer_id']); ?>" />
            <span></span></td>
        </tr>
        <tr>
          <th><i>*</i>税务登记证号电子版：</th>
  ...
  <div class="bottom"><a id="btn_apply_credentials_next" href="javascript:;" class="btn">下一步，提交管理人信息</a></div>
</div>
...
$(document).ready(function(){
    ...
    $("#is_settlement_account").on("click", function() {
        if($(this).prop("checked")) {
            ...
            $("#settlement_bank_account_number").val("<?php echo _decrypt($output['store_info']['settlement_bank_account_number']); ?>");
            $("#settlement_bank_name").val("<?php echo $output['store_info']['settlement_bank_name']; ?>");
            $("#settlement_bank_code").val("<?php echo _decrypt($output['store_info']['settlement_bank_code']); ?>");
