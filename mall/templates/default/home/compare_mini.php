...
<div class="btn-box">
  ...
  <span style="background-color: #0094DE; color: #FFFFFF; cursor: pointer; padding: 5px 10px;" onclick="javascript:window.open('index.php?con=compare&gids=<?php echo $output['goodsid_str'];?>');">对比</span>
