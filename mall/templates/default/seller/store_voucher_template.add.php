  ...
  <div class="tabmenu">
	...
	<div class="ncsc-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?con=store_voucher&fun=<?php echo $output['type']=='add'?'templateadd':'templateedit'; ?>">
	  	<input type="hidden" id="con" name="con" value="store_voucher"/>
	  	<?php if ($output['type'] == 'add'){?>
	  	<input type="hidden" id="fun" name="fun" value="templateadd"/>
	  	<?php }else {?>
	  	<input type="hidden" id="fun" name="fun" value="templateedit"/>
