...
$(function(){
	$.getJSON('index.php?con=seller_center&fun=get_express&e_code=<?php echo $output['express_e_code'];?>&shipping_code=<?php echo $output['return']['invoice_no'];?>&t=<?php echo random(7);?>',function(data){
		if(data){
