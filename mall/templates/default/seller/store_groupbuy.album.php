<div class="groupbuy-gallery"> <a class='sample_demo' id="select_s" href="index.php?con=store_album&fun=pic_list&item=groupbuy" style="display:none;"><?php echo $lang['store_goods_batch_edit_submit'];?></a>
