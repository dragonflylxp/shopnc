...
<?php } ?>
<form action="index.php?con=store_complain&fun=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?con=store_complain&fun=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?con=store_complain&fun=publish_complain_talk',
                cache:false,
