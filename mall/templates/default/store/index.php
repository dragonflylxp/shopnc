...
?>
	      <?php if(!empty($output['store_info']['store_quanjing'])){?>
<div class="quanjing" style="padding-left: 12.11%;z-index:-1">
<embed src="<?php echo $output['store_info']['store_quanjing'];?>" allowFullScreen="true" quality="high" width="1200" height="600" wmode="opaque" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>
    </div>
	    <?php } ?>
