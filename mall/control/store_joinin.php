...
class store_joininControl extends BaseHomeControl {
    ...
    public function step4Op() {
        ...
        $param['quality_report'] = $_POST['quality_report1'];
        $param['trade_mark_license'] = $_POST['trade_mark_license1'];
    ...
    public function payOp() {
        ...
        $this->joinin_detail['quality_report'] = explode('|', $this->joinin_detail['quality_report']);
        $this->joinin_detail['trade_mark_license'] = explode('|', $this->joinin_detail['trade_mark_license']);
        $this->joinin_detail['authorization'] = explode('|', $this->joinin_detail['authorization']);
        $this->joinin_detail['other_qualifications'] = explode('|', $this->joinin_detail['other_qualifications']);
        $this->joinin_detail['identity_card_electronic'] = explode('|', $this->joinin_detail['identity_card_electronic']);
