...
$lang['login_register_username_range']		= "用戶名必須在6-20個字元之間";
$lang['login_register_username_lettersonly']= "可包含“_”、“-”，不能是純數字";
...
$lang['login_register_input_referral_code']	= "這不是一個有效的推薦碼";
$lang['login_register_input_text_in_image']	= "請輸入驗證碼";
$lang['login_register_code_wrong']			= "驗證碼不正確";
$lang['login_register_must_agree']			= "請勾選服務協議";
$lang['login_register_join_us']				= "用戶註冊";
$lang['login_register_input_info']			= "填寫用戶註冊資訊";
$lang['login_register_username']			= "用戶名";
$lang['login_register_username_to_login']	= "請使用6-20個中、英文、數字及“-”符號";
$lang['login_register_pwd']					= "設置密碼";
$lang['login_register_password_to_login']	= "您的登錄密碼";
$lang['login_register_password_to_login']	= "6-20個大小寫英文字母、符號或數字";
$lang['login_register_ensure_password']		= "確認密碼";
$lang['login_register_input_password_again']= "請再次輸入密碼";
$lang['login_register_referral_code']		= "推薦碼";
$lang['login_register_input_valid_referral_code']	= "輸入推薦碼(可選)";
$lang['login_register_email']				= "郵箱";
$lang['login_register_input_valid_email']	= "輸入常用郵箱作為驗證及找回密碼使用";
$lang['login_register_code']				= "驗證碼";
$lang['login_register_click_to_change_code']= "換一張";
$lang['login_register_input_code']			= "輸入驗證碼";
$lang['login_register_agreed']				= "閱讀並同意";
...
$lang['login_register_collect_info']		= "收藏商品關注店鋪";
$lang['login_register_honest_info']			= "安全交易誠信無憂";
$lang['login_register_talk_info']			= "會員等級享受特權";
$lang['login_register_openstore_info']		= "積分獲取優惠購物";
$lang['login_register_sns_info']			= "評價曬單站外分享";


$lang['login_register_already_have_account']= "如果您是本站用戶";
$lang['login_register_login_now_1']			= "我已經註冊，現在就";
...
$lang['login_password_you_account']	= '登錄帳號';
