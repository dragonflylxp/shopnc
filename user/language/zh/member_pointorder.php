...
$lang['member_pointorder_record_error']			= '記錄資訊錯誤';
...
$lang['member_pointorder_exchangepoints']		= '積分';
$lang['member_pointorder_shippingfee']			= '運費（元）';
$lang['member_pointorder_exchangepoints_shippingfee'] = '合計（積分）';
...
$lang['member_pointorder_exnum']				= '數量';
 ...
 * 兌換資訊列表
 */
$lang['member_pointorder_cancel_tip1']				= '取消兌換禮品資訊';
...
$lang['member_pointorder_cancel_confirmtip']		= '確認取消兌換資訊?';
$lang['member_pointorder_viewinfo']					= '查看詳細';
/**
 * 兌換資訊詳細
 */
$lang['member_pointorder_info_ordersimple']		= '兌換資訊';
$lang['member_pointorder_info_memberinfo']		= '會員資訊';
$lang['member_pointorder_info_membername']		= '會員名稱';
$lang['member_pointorder_info_memberemail']		= 'Email';
$lang['member_pointorder_info_ordermessage']	= '買家留言';
$lang['member_pointorder_info_paymentinfo']		= '支付資訊';
$lang['member_pointorder_info_paymenttime']		= '支付時間';
$lang['member_pointorder_info_paymentmessage']	= '支付留言';
$lang['member_pointorder_info_shipinfo']		= '收貨地址';
$lang['member_pointorder_info_shipinfo_truename']= '收貨人';
$lang['member_pointorder_info_shipinfo_areainfo']= '所在地區';
$lang['member_pointorder_info_shipinfo_zipcode']= '郵遞區號';
...
$lang['member_pointorder_info_prodinfo']			= '禮品資訊';
