...
class ManagerControl extends Control {
    ...
    public function __construct(){
         ...
         * 设置布局文件内容
         */
        Tpl::setLayout('manager_login_layout');
        ...
        if ($_GET['con'] !== 'manager_login') {

            if(empty($_SESSION['manager_id'])) {
                @header('location: index.php?con=manager_login&fun=index');die;
            }
        }
    }
...
//***********************************区域管理员control父类******by suijiaolong*******end**********************
