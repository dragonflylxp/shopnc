...
class loginControl extends BaseLoginControl {
    ...
    public function logoutOp(){
        ...
        redirect(LOGIN_SITE_URL . '/index.php?con=login&ref_url='.urlencode($ref_url));
    }
    ...
    public function usersaveOp() {
        ...
        $register_info['referral_code'] = trim($_POST['referral_code']);
     ...
     * @return
     */
    public function check_referral_codeOp() {
