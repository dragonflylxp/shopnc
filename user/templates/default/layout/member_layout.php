    ...
    <div class="ncm-header-top">
      <div class="ncm-member-info">
        <div class="avatar"><a href="<?php echo urlMember('member_information', 'avatar');?>" title="修改头像"><img src="<?php echo getMemberAvatar($output['member_info']['member_avatar']);?>">
          ...
          <a href="<?php echo MEMBER_SITE_URL?>index.php?con=member_message&fun=message" class="new-message" title="新消息"><?php echo intval($output['message_num']); ?></a>
          <?php }?>
        </div>
        <dl>
    ...
    <div class="ncm-header-nav">
      <ul class="nav-menu">
        ...
        <li class="distri"><a href="<?php echo urlDistribute('distri_center', 'home');?>">分销中心<i></i></a> 
            ...
            <dl>
              <dt><a href="<?php echo urlDistribute('access_infomation', 'member')?>" style="color: #3AAC8A">财产中心</a></dt>
              ...
              <dd><a href="<?php echo urlDistribute('commission', 'commission_info')?>">账户余额</a></dd>
                <dd><a href="<?php echo urlDistribute('member_banks', 'banks');?>">我的银行卡</a></dd>
    ...
    <ul id="sidebarMenu" class="ncm-sidebar">
      ...
      <li class="side-menu"><a href="javascript:void(0)" key="<?php echo $key;?>" <?php if (cookie('Mmenu_'.$key) == 1) echo 'class="shrink"';?>>
        ...
        <ul <?php if (cookie('Mmenu_'.$key) == 1) echo 'style="display:none"';?>>
          ...
          <li <?php if ($key == $output['con']) {?>class="selected"<?php }?>><a href="<?php echo $val['url'];?>"><?php echo $val['name'];?></a></li>
          <?php }?>
        </ul>
        <?php }?>
      </li>
