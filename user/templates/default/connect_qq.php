        ...
        <div id="register" class="tabs-content">
          <form name="register_form" id="register_form" class="nc-login-form" method="post" action="index.php?con=connect_qq&fun=register">
            ...
            <dl>
              ...
              <dd>
                <input type="text" value="<?php echo $output['user_passwd'];?>" id="password" name="password" class="text" placeholder="<?php echo $lang['login_register_password_to_login'];?>"/>
              </dd>
            </dl>
            <dl class="mt15">
              <dt><?php echo $lang['login_register_email']; ?>：</dt>
              <dd>
                <input type="text" id="email" name="email" class="text" placeholder="<?php echo $lang['login_register_input_valid_email'];?>"/>
              </dd>
            </dl>
