                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <input type="text" id="user_name" name="user_name" class="text"
                                               placeholder="<?php echo $lang['login_register_username_to_login']; ?>"/>
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        <input type="password" id="password" name="password" class="text"
                                               placeholder="<?php echo $lang['login_register_password_to_login']; ?>"/>
                                    </dd>
                                </dl>
                                <dl>
                                    ...
                                    <dd>
                                        <input type="password" id="password_confirm" name="password_confirm"
                                               class="text"
                                               placeholder="<?php echo $lang['login_register_input_password_again']; ?>"/>
                                    </dd>
                                </dl>
                                <dl class="mt15">
                                    ...
                                    <dd>
                                        <input type="text" id="email" name="email" class="text"
                                               placeholder="<?php echo $lang['login_register_input_valid_email']; ?>"/>
                                    </dd>
                                </dl>
                                <dl class="mt15">
                                    <dt><?php echo $lang['login_register_referral_code']; ?>：</dt>
                                    <dd>
                                        <input type="text" id="referral_code" name="referral_code" class="text"
                                               placeholder="<?php echo $lang['login_register_input_valid_referral_code']; ?>"/>
                                    </dd>
                                </dl>
                                        ...
                                        <dl>
                                            ...
                                            <dd>
                                                <input type="text" id="captcha" name="captcha" class="text w80"
                                                       size="10"
                                                       placeholder="<?php echo $lang['login_register_input_code']; ?>"/>
                                            </dd>
                                        </dl>
                                        <span><img
                                                ...
                                                name="codeimage" id="codeimage"/> <a class="makecode"
                                                                                     ...
                                                                                     onclick="javascript:document.getElementById('codeimage').src='index.php?con=seccode&fun=makecode&type=50,120&nchash=<?php echo getNchash(); ?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span>
                                    </div>
                                <?php } ?>
                                <dl class="clause-div">
                                    <dd>
                            ...
                            <div id="mobile" class="tabs-content">
                                <form id="post_form" method="post" class="nc-login-form">
                                    ...
                                    <dl>
                                        <dt>手机号：</dt>
                                        <dd>
                                            <input type="text" class="text" placeholder="请输入手机号码" autocomplete="off" value=""
                                                   name="phone" id="phone">
                                        </dd>
                                    </dl>
                                    <div class="code-div">
                                        ...
                                        <span><img
                                                ...
                                                name="codeimage" id="sms_codeimage"><a class="makecode"
                                                                                       href="javascript:void(0);"
                                                                                       onclick="javascript:document.getElementById('sms_codeimage').src='index.php?con=seccode&fun=makecode&type=50,120&nchash=<?php echo getNchash(); ?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span>
                                    </div>
                                    ...
                                    <dl>
                                        <dt>短信验证：</dt>
                                        <dd>
                                            <input type="text" name="sms_captcha" autocomplete="off" placeholder="输入6位短信验证码"
                                ...
                                <form style="display: none;" id="register_sms_form" class="nc-login-form" method="post"
                                    ...
                                    <dl class="mt15">
                                        <dt><?php echo $lang['login_register_referral_code']; ?>：</dt>
                                        <dd>
                                            <input type="text" id="phone_referral_code" name="referral_code" class="text"
                                                   placeholder="<?php echo $lang['login_register_input_valid_referral_code']; ?>"/>
                                        </dd>
                                    </dl>
                                    <dl class="clause-div">
            ...
            <div class="right">
                <?php if (C('qq_isuse') == 1 || C('sina_isuse') == 1 || C('weixin_isuse') == 1) { ?>
                    <div class="api-login">
                        <h4>使用合作网站账号直接登录</h4>
                        <?php if (C('qq_isuse') == 1) { ?>
                            <a href="<?php echo MEMBER_SITE_URL; ?>/index.php?con=connect_qq" title="QQ账号登录" class="qq"><i></i></a>
                        <?php } ?>
                        <?php if (C('sina_isuse') == 1) { ?>
                            <a href="<?php echo MEMBER_SITE_URL; ?>/index.php?con=connect_sina"
        ...
        $("#register_form").validate({
            ...
            rules: {
                ...
                referral_code: {
                    ...
                    referral_code: true,
                    remote: {
                        url: 'index.php?con=login&fun=check_referral_code',
                        type: 'get',
                        data: {
                            referral_code: function () {
                                if($.trim($('#referral_code').val())=='<?php echo $lang['login_register_input_valid_referral_code']; ?>'){
                                    return '';
                                }else {
            ...
            messages: {
                ...
                referral_code: {
                    referral_code: '<i class="icon-exclamation-sign"></i><?php echo $lang['login_register_input_referral_code'];?>',
                    remote: '<i class="icon-exclamation-sign"></i><?php echo $lang['login_register_input_referral_code'];?>',
                },
                <?php if(C('captcha_status_register') == '1') { ?>
                captcha: {
                ...
                rules: {
                    ...
                    referral_code: {
                        ...
                        remote: {
                            ...
                            data: {
                                referral_code: function () {
                                    if($.trim($('#phone_referral_code').val())=='<?php echo $lang['login_register_input_valid_referral_code']; ?>'){
                                        return '';
                                    }else {
                                        return $('#phone_referral_code').val();
                                    }
                                }
                            }
                        }
