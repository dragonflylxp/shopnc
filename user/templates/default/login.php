...
<div class="nc-login-layout">
  ...
  <div class="arrow"></div>
        ...
        <div id="default" class="tabs-content">
          <form id="login_form" class="nc-login-form" method="post" action="<?php echo urlLogin('login', 'login');?>">
            ...
            <dl>
              ...
              <dd>
                <input type="password" class="text" name="password" autocomplete="off" placeholder="<?php echo $lang['login_register_password_to_login'];?>" id="password">
              </dd>
            </dl>
            ...
            <div class="code-div mt15">
              <dl>
                ...
                <dd>
                  <input type="text" name="captcha" autocomplete="off" class="text w100" placeholder="<?php echo $lang['login_register_input_code'];?>" id="captcha" size="10" />
                </dd>
              </dl>
          ...
          <form id="post_form" method="post" class="nc-login-form" action="<?php echo urlLogin('connect_sms', 'login');?>">
            ...
            <div class="code-div">
              <dl>
                ...
                <dd>
                  <input type="text" name="captcha" class="text w100" placeholder="<?php echo $lang['login_register_input_code'];?>" id="image_captcha" size="10" />
    ...
    <div class="nc-login-api" id="demo-form-site">
      ...
      <?php if (C('qq_isuse') == 1){?>
      <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=connect_qq" title="QQ账号登录" class="qq"><i></i>QQ</a>
      <?php } ?>
      <?php if (C('sina_isuse') == 1){?>
      <a href="<?php echo MEMBER_SITE_URL;?>/index.php?con=connect_sina" title="新浪微博账号登录" class="sina"><i></i>新浪微博</a>
      <?php } ?>
