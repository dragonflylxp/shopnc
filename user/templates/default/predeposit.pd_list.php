    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <td class="ncm-table-handle"><?php if (!intval($val['pdr_payment_state'])){?>
          ...
          <p>支付</p>
          </a></span> <span><a class="btn-grapefruit" href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', '<?php echo MEMBER_SITE_URL;?>/index.php?con=predeposit&fun=recharge_del&id=<?php echo $val['pdr_id']; ?>');"><i class="icon-trash"></i>
