        ...
        <div id="default" class="tabs-content">
          <form class="nc-login-form" action="<?php echo urlLogin('login', 'find_password');?>" method="POST" id="find_password_form">
            ...
            <dl>
              ...
              <dd>
                <input type="text" class="text" name="username" placeholder="输入您已注册的用户名" />
              </dd>
            </dl>
            <dl>
              <dt><?php echo $lang['login_password_you_email'];?>：</dt>
              <dd>
                <input type="text" class="text" name="email" placeholder="输入您已注册的邮箱" />
              </dd>
            </dl>
            <div class="code-div mt15">
              <dl>
                ...
                <dd>
                  <input type="text" name="captcha" class="text w100" id="captcha" size="10" placeholder="输入验证码" />
                </dd>
              </dl>
        ...
        <div id="mobile" class="tabs-content">
          <form id="post_form" method="post" class="nc-login-form" action="<?php echo urlLogin('connect_sms', 'find_password');?>">
            ...
            <dl>
              <dt>手机号：</dt>
              <dd>
                <input type="text" class="text" autocomplete="off" value="" name="phone" id="phone" placeholder="输入您已注册的手机号" >
              </dd>
            </dl>
            <div class="code-div">
              <dl>
                <dt><?php echo $lang['login_register_code'];?>：</dt>
                <dd>
                  <input type="text" name="captcha" class="text w100" id="image_captcha" size="10" placeholder="输入验证码" />
              </dl>
            ...
            <dl>
              <dt>短信验证：</dt>
              <dd>
                <input type="text" name="sms_captcha" autocomplete="off" class="text w100" id="sms_captcha" size="15"  placeholder="输入动态码" />
              </dd>
            </dl>
            <dl>
              <dt>新密码：</dt>
              <dd>
                <input type="text" name="password" id="password" class="text"  placeholder="输入您修改的密码" />
              </dd>
            </dl>
            <div class="submit-div">
