      ...
      <ul class="form-box">
        ...
        <li class="form-item">
          ...
          <div class="input-box">
            ...
            <input type="text" pattern="[0-9]*" class="inp" name="goods_num" placeholder="退货数量不能超过可退数量">
...
<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/js/list/return.js"></script>
