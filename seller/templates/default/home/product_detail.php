...
<div class="goods-detail-cnt">
		...
		<div class="item-con">
			...
			<dl class="goods-detail-sale">
				...
				<dd class="gift-item">
					...
					<a href="<%=ApiUrl%>/index.php?con=goods&fun=detail&goods_id=<%= v.gift_goodsid %>"><%= v.gift_goodsname %></a>
	...
	<div class="goods-detail-store">
		...
		<a href="<%=ApiUrl%>/index.php?con=store&fun=index&store_id=<%= store_info.store_id %>">
		...
		<ul>
			...
			<%for (var i = 0;i<goods_commend_list.length;i++){%>
				...
				<li>
					...
					<a href="<%=ApiUrl%>/index.php?con=goods&fun=detail&goods_id=<%=goods_commend_list[i].goods_id%>">
	...
	<div class="goods-detail-foot">
		...
		<div class="otreh-handle">
			...
			<a href="javascript:void(0);" class="kefu" id="kefu" qq="<%= store_info.store_qq %>"><i></i><p>客服</p></a>

			<a href="javascript:void(0);" class="cart" id="cart"><i></i><p>购物车</p><span id="cart_count"></span></a>
...
<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/js/fly/requestAnimationFrame.js"></script>

<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/js/fly/zepto.fly.min.js"></script>

<script type="text/javascript" src="<?php echo MOBILE_TEMPLATES_URL;?>/js/list/product_detail.js"></script>
