...
class autoControl extends mobileMemberControl{
	...
	public function loginOp(){
		...
		$redirect_uri = MOBILE_SITE_URL."/index.php?con=auto&fun=checkAuth&ref=".urlencode($_GET['ref']);
	...
	public function checkAuthOp(){
		...
		// p(strstr($ref,'register'));

		// p(WAP_SITE_URL);

		// p(empty($ref) || strstr($ref,'register'));
		...
		if (isset($_GET['code'])){				
			...
			// p(strstr($ref,'register_invite'));die;
