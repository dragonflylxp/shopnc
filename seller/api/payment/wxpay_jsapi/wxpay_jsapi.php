...

{
...

    {
        ...
        $this->config = (object) array(
            ...
            'finishedUrl' => MOBILE_SITE_URL . '/index.php?con=payment&fun=wxpayment_message&ok=1',

            'undoneUrl' => MOBILE_SITE_URL . '/index.php?con=payment&fun=wxpayment_message&ok=0',
    ...
    WeixinJSBridge.invoke(
        ...
        function(res) {
            ...
            if (res && res.err_msg == "get_brand_wcpay_request:ok") {
                ...
                if(res && res.err_msg == "get_brand_wcpay_request：cancel"){
