...
function orderPaymentName($payment_code) {
    return str_replace(
            array('offline','online','ghtpay','ghtmixpay','ali_native','alipay','tenpay','chinabank','predeposit','wxpay','wx_jsapi','wx_saoma','chain','offbank','dhq'),
            array('货到付款','在线付款','高汇通','高汇通','支付宝移动支付','支付宝','财付通','网银在线','站内余额支付','微信支付[客户端]','微信支付[jsapi]','微信支付[扫码]','门店支付','银行汇款','兑换卷兑换'),
            $payment_code);
}
