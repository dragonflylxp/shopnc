$(function(){
    ...
    $('#keyword').on('input',function(){
    	...
    	if (value == '') {
            ...
            $.getJSON(ApiUrl + '/index.php?con=goods&fun=auto_complete',{term:$('#keyword').val()}, function(result) {
    ...
    $.getJSON(ApiUrl + '/index.php?con=index&fun=search_key_list', function(result) {
    	var data = result.datas;
    	data.WapSiteUrl = WapSiteUrl;
