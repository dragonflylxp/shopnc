        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (!data.error) {
					...
					document.title=data.goods_seo.html_title;
					$("meta[name='keywords']").attr('content',data.goods_seo.seo_keywords);
					$("meta[name='description']").attr('content',data.goods_seo.seo_description);
    ...
    $('#product_detail_html').on('click', '#get_area_selected', function () {
        $.areaSelected({
            success: function (data) {
                ...
                $.getJSON(ApiUrl + '/index.php?con=goods&fun=calc', {goods_id: goods_id, area_id: area_id}, function (result) {
...
function virtual() {
    ...
    $.getJSON(ApiUrl + '/index.php?con=goods&fun=store_o2o_addr', {store_id: store_id}, function (result) {
        if (!result.datas.error) {
