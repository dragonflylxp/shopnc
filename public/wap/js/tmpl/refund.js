...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?con=member_refund&fun=refund_form',{key:key,order_id:getQueryString('order_id'),order_goods_id:getQueryString('order_goods_id')}, function(result) {
