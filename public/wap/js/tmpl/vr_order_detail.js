...
$(function(){
    ...
    $.getJSON(ApiUrl + '/index.php?con=member_vr_order&fun=order_info',{key:key,order_id:order_id}, function(result) {
        ...
        $.getJSON(ApiUrl + '/index.php?con=goods&fun=store_o2o_addr', {store_id:result.datas.order_info.store_id},function(result){
        	if (result.datas.error) {
        		return ;
        	}
    ...
    function toSend(){
    	...
    	$.ajax({
            type:"post",
            url:ApiUrl+"/index.php?con=member_vr_order&fun=resend",
