        ...
        $message = Language::get('nc_common_save_fail');
            ...
            if($result) {
                ...
                if(isset($_POST['share_app_items'])) {
                    ...
                    $commend_goods_info['url'] = MICROSHOP_SITE_URL.DS."index.php?con=goods&fun=detail&goods_id=".$result;
    ...
    public function personal_saveOp() {
        ...
        if($result) {
            ...
            if(isset($_POST['share_app_items'])) {
                ...
                $personal_info['url'] = MICROSHOP_SITE_URL.DS."index.php?con=personal&fun=detail&personal_id=".$result;
                self::share_app_publish('publish',$personal_info);
            }
        }
        showDialog($message,MICROSHOP_SITE_URL.DS.'index.php?con=home&fun=personal',$result? 'succ' : 'error','');
    }
