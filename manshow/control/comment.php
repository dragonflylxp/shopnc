    ...
    public function comment_saveOp() {
        ...
        if(!empty($_SESSION['member_id'])) {
            ...
            if($result) {
                ...
                $data['member_link'] = MICROSHOP_SITE_URL.'/index.php?con=home&member_id='.$_SESSION['member_id'];
                ...
                if(isset($_POST['share_app_items'])) {
                    ...
                    $info['type'] = $_GET['type'];
                    $info['url'] = MICROSHOP_SITE_URL.DS."index.php?con={$_GET['type']}&fun=detail&{$_GET['type']}_id=".$_POST['comment_id'].'#widgetcommenttitle';
