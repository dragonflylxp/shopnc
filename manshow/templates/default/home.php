...
$(document).ready(function(){
    $("[nc_type=home_drop]").click(function(){
        if(confirm('<?php echo $lang['nc_ensure_del'];?>')) {
            ...
            $.getJSON("index.php?con=home&fun=home_drop", { type: $(this).attr("type"),item_id: $(this).attr("item_id")}, function(json){
                if(json.result == "true") {
                    item.remove();
    ...
    $("#btn_sns_addfollow").live('click',function(){
        $.getJSON("<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&fun=add_follow&member_id=<?php echo $output['member_info']['member_id'];?>", {}, function(json){
            if(json.result == "true") {
	...
	$("#btn_sns_delfollow").live('click',function(){
        $.getJSON("<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&fun=del_follow&member_id=<?php echo $output['member_info']['member_id'];?>", {}, function(json){
            if(json.result == "true") {
...
<div class="user-page-nav">
  <ul>
    <li <?php echo $output['home_sign'] == 'goods'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=home&fun=goods&member_id=<?php echo $output['member_info']['member_id'];?>" class="pngFix"><i class="link2 pngFix"></i><span><?php echo $lang['nc_microshop_goods'];?></span></a></li>
    <!--
        <li <?php echo $output['home_sign'] == 'album'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=home&fun=album&member_id=<?php echo $output['member_info']['member_id'];?>"><i class="link3"></i><span><?php echo $lang['nc_microshop_album'];?></span></a></li>
        -->
    <li <?php echo $output['home_sign'] == 'personal'?'class="current pngFix"':'class="link pngFix"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=home&fun=personal&member_id=<?php echo $output['member_info']['member_id'];?>" class="pngFix"><i class="link4 pngFix"></i><span><?php echo $lang['nc_microshop_personal'];?></span></a></li>
    <li <?php echo $output['home_sign'] == 'like'?'class="current pngFix"':'class="link pngFix"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=home&fun=like_list&member_id=<?php echo $output['member_info']['member_id'];?>" class="pngFix"><i class="link5 pngFix"></i><span><?php echo $lang['nc_microshop_like'];?></span></a></li>
  </ul>
</div>
<?php 
