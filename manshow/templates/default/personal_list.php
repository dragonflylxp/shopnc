...
<div class="personal-class">
  <ul>
    ...
    <li><a <?php if($_GET['class_id'] == $val['class_id']) {echo "class='selected pngFix'";} else {echo "class='pngFix'";}?> href="index.php?con=personal&class_id=<?php echo $val['class_id'];?>">
...
<div class="microshop-order"><span><?php echo $lang['microshop_text_order'].$lang['nc_colon'];?></span>
  <ul>
    <li class="l"><a <?php if($_GET['order'] == 'new' || empty($_GET['order'])) echo "class='selected'";?> href="index.php?con=personal&class_id=<?php echo $_GET['class_id'];?>&order=new"><?php echo $lang['microshop_text_new'];?></a></li>
    <li class="r"><a <?php if($_GET['order'] == 'hot') echo "class='selected'";?> href="index.php?con=personal&class_id=<?php echo $_GET['class_id'];?>&order=hot"><?php echo $lang['microshop_text_hot'];?></a></li>
  </ul>
</div>
<?php } ?>
