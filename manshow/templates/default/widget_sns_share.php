...
<div id="div_sns_share" style="display:none;">
    <form action="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=share&fun=share_save&type=<?php echo $_GET['con'];?>" method="post" id="share_form" class="feededitor">
