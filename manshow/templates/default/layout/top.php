...
<script type="text/javascript">
    ...
    $("[nc_type='bindbtn']").bind('click',function(){
            ...
            window.open('<?php echo MEMBER_SITE_URL.DS;?>api.php?con=sharebind&type='+data_str.apikey);
            }
    });
    $("#finishbtn").live('click',function(){
            ...
            eval( "data_str = "+data_str);
            //验证是否绑定成功
            var url = '<?php echo urlMember('member_sharemanage');?>&fun=checkbind&callback=?';
...
<div class="public-top-layout w">
  <div class="topbar warp-all">
    ...
    <div class="quick-menu">
      <dl>
        <dt><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_order">我的订单</a><i></i></dt>
        <dd>
          <ul>
      ...
      <dl>
        <dt><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_favorite_goods&fun=fglist"><?php echo $lang['nc_favorites'];?></a><i></i></dt>
        <dd>
          <ul>
    ...
    <div class="micro-search">
      <div class="ms-box">
        <div id="micro_search" class="ms-type">
          <?php if(in_array($_GET['con'],array_keys($output['search_type']))) { ?>
          <span id="micro_search_type" search_type="<?php echo $_GET['con'];?>"><?php echo $output['search_type'][$_GET['con']];?></span>
          <?php } else { ?>
      ...
      <div class="ms-form">
        <form id="form_search" method="get" action="<?php echo MICROSHOP_SITE_URL;?>/index.php">
          <?php if(in_array($_GET['con'],array_keys($output['search_type']))) { ?>
          <input id="con" name="con" type="hidden" value="<?php echo $_GET['con'];?>"/>
          <?php } else { ?>
          <input id="con" name="con" type="hidden" value="goods"/>
          <?php } ?>
...
<div id="navBar" class="pngFix">
  <div id="navBox">
    <ul class="nc-nav-menu">
      ...
      <li <?php echo $output['index_sign'] == 'goods'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=goods" class="pngFix"><span class="pngFix"><?php echo $lang['nc_microshop_goods'];?></span></a></li>
      <!--
      <li <?php echo $output['index_sign'] == 'album'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=album"><span><?php echo $lang['nc_microshop_album'];?></span></a></li>
      -->
      <li <?php echo $output['index_sign'] == 'personal'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=personal" class="pngFix"><span class="pngFix"><?php echo $lang['nc_microshop_personal'];?></span></a></li>
      <li <?php echo $output['index_sign'] == 'store'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=store" class="pngFix"><span class="pngFix"><?php echo $lang['nc_microshop_store'];?></span></a></li>
    </ul>
    <div class="microMall-user">
      ...
      <ul class="sub-menu">
        ...
        <li class="pngFix"><a href="javascript:void(0)"><span title="<?php echo $_SESSION['member_name'];?>"><?php echo $_SESSION['member_name'];?></span><i></i></a>
          <ul>
            <li><a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=goods'?>"><?php echo $lang['nc_microshop_goods'];?></a></li>
            <li><a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=personal'?>"><?php echo $lang['nc_microshop_personal'];?></a></li>
            <!--
            <li> <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=album'?>"><?php echo $lang['nc_microshop_album'];?></a> </li>
            -->
          </ul>
        </li>
        <?php } else { ?>
        ...
        <li class="pngFix"><a href="javascript:void(0)"><?php echo $lang['nc_publish'];?><i></i></a>
          <ul>
            <li><a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=publish&fun=goods_buy';?>"><?php echo $lang['microshop_goods_buy'];?></a> </li>
            <li><a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=publish&fun=goods_favorites';?>"><?php echo $lang['microshop_goods_favorite'];?></a> </li>
            <li><a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=personal&publish=personal';?>"><?php echo $lang['nc_microshop_personal'];?></a> </li>
            <!--
            <li> <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=publish&fun=album';?>"><?php echo $lang['nc_microshop_album'];?></a> </li>
            -->
          </ul>
        </li>
        <li class="pngFix"><a href="javascript:void(0)"><?php echo $lang['microshop_text_like'];?><i></i></a>
          <ul>
            <li> <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=like_list&type=goods'?>"><?php echo $lang['nc_microshop_goods'];?></a> </li>
            <!--
            <li> <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=like_list&type=personal'?>"><?php echo $lang['nc_microshop_album'];?></a> </li>
            -->
            <li> <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=like_list&type=personal'?>"><?php echo $lang['nc_microshop_personal'];?></a> </li>
            <li> <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=home&fun=like_list&type=store'?>"><?php echo $lang['nc_microshop_store'];?></a> </li>
          </ul>
        </li>
      </ul>
    </div>
