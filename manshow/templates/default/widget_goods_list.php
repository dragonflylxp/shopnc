...
<div class="commend-goods-list">
    <ul id="pinterest">
        ...
        <?php } ?>
        <?php } ?>
        <div class="picture"> <a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=goods&fun=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank">
        ...
        <div class="handle">
            ...
            <span class="comment"><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=goods&fun=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank"><i title="<?php echo $lang['microshop_comment'];?>" class="pngFix">&nbsp;</i><em><?php echo $value['comment_count']<=999?$value['comment_count']:'999+';?></em></a></span>
        </div>
        <dl class="commentary">
            ...
            <p> <a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=goods&fun=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank"> <?php echo $value['commend_message'];?> </a> </p>
            </dd>
        </dl>
        </li>
        <?php } ?>
...
<div class="no-content"> <i class="goods pngFix"></i>
    ...
    <?php } else { ?>
        ...
        <?php } else { ?>
            ...
            <a href="<?php echo MICROSHOP_SITE_URL.'/index.php?con=publish&fun=goods_buy';?>"><?php echo $lang['microshop_goods_publish'];?></a>
            <?php } else { ?>
