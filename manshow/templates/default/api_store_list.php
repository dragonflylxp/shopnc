...
<div class="title-bar">
  ...
  <a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=store" class="more" target="_blank"><?php echo $lang['nc_more'];?></a> </div>
  ...
  <ol nc_type="index_store" class="microshop-store-list">
    ...
    <li class="overall" style="display:none;"><i><?php echo $i;?></i>
      <dl class="store-intro">
        ...
        <dd><a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=store&fun=detail&store_id=<?php echo $value['microshop_store_id'];?>" target="_blank"><?php echo $lang['micro_api_store_info'];?></a></dd>
      </dl>
    </li>
