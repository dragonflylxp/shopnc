...
$(document).ready(function() {
    ...
    $("[nc_type='btn_sns_addfollow']").live('click',function(){
        ...
        $.getJSON("<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&fun=add_follow", {member_id:$(this).attr('member_id')}, function(json){
            if(json.result == "true") {
                btn_add.hide();
                btn_del.show();
                if(json.message != 're') {
	...
	$("[nc_type='btn_sns_delfollow']").live('click',function(){
        ...
        var follow_count = $(this).parent().parent().find("[nc_type='fan_count']");
        $.getJSON("<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&fun=del_follow", {member_id:$(this).attr('member_id')}, function(json){
            if(json.result == "true") {
                btn_add.show();
                btn_del.hide();
                follow_count.microshop_count({type:'-'});
...
<div class="index">
  ...
  <div class="right">
    <div class="member-box">
      ...
      <?php } else { ?>
      <div class="portrait"> <a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&member_id=<?php echo $_SESSION['member_id'];?>" target="_blank"> <img src="<?php echo $member_avatar;?>" onload="javascript:DrawImage(this,72,72);" /> </a> </div>
      <dl class="welcome">
        <dt> <a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&member_id=<?php echo $_SESSION['member_id'];?>" target="_blank"> <?php echo $output['member_info']['member_name'];?> </a> </dt>
    ...
    <div class="user-box">
      ...
      <dl class="big-gun">
        <dt class="portrait"><a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&member_id=<?php echo $value['member_id'];?>" target="_blank"><img src="<?php echo getMemberAvatar($value['member_avatar']);?>" onload="javascript:DrawImage(this,60,60);" /></a></dt>
        <dd class="name"> <a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=home&member_id=<?php echo $value['member_id'];?>" target="_blank"> <?php echo $value['member_name'];?> </a> </dd>
...
<div class="main-box personal">
  ...
  <ul id="indexPersonal" class="jcarousel-skin-personal">
    ...
    <li style="background-image: url(<?php echo $personal_image_array[0];?>)"><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=personal&fun=detail&personal_id=<?php echo $value['personal_id'];?>"></a>
      <div class="arrow">&nbsp;</div>
      <dl>
        <dt><img src="<?php echo getMemberAvatar($value['member_avatar']);?>" onload="javascript:DrawImage(this,30,30);" /></dt>
        <dd> <a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=home&member_id=<?php echo $value['commend_member_id'];?>"> <?php echo $value['member_name'];?> </a>
...
<div class="main-box goods">
  ...
  <ul class="goods-class-pic">
    ...
    <li style="background-image: url(<?php echo $image_url;?>)" ><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=goods&fun=detail&goods_id=<?php echo $value_goods['commend_id'];?>" title="<?php echo $value_goods['commend_goods_name'];?>">&nbsp;</a>
  ...
  <div class="goods-class-list">
    ...
    <dl>
      <dt><a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=goods&goods_class_root_id=<?php echo $value['class_id'];?>&goods_class_menu_id=<?php echo $value_menu['class_id'];?>"><?php echo $value_menu['class_name'];?></a></dt>
      ...
      <dd>
        ...
        <a <?php if($_GET['keyword'] == ltrim($val1,'*')) { echo "class='selected'";} elseif(substr($val1,0,1) == '*') { echo "class='highlight'";}?> href="index.php?con=goods&goods_class_root_id=<?php echo $value['class_id'];?>&goods_class_menu_id=<?php echo $value_menu['class_id'];?>&keyword=<?php echo ltrim($val1,'*');?>"><?php echo ltrim($val1,'*');?></a>
        <?php } ?>
      </dd>
      <?php } ?>
    </dl>
    <?php } ?>
    <?php } ?>
    <div class="more"><a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=goods&goods_class_root_id=<?php echo $value['class_id'];?>"><?php echo $lang['microshop_text_all'];?>...</a></div>
  </div>
</div>
<?php } ?>
<?php } ?>
      ...
      <ol nc_type="index_store" style="padding-left: 7px;">
        ...
        <li class="overall"><i><?php echo $i+1;?></i>
          <dl class="store-intro">
            <dt><a href="<?php echo MICROSHOP_SITE_URL.DS;?>index.php?con=store&fun=detail&store_id=<?php echo $output['store_list'][$i]['microshop_store_id'];?>" target="_blank"><?php echo $output['store_list'][$i]['store_name'];?></a></dt>
