...
<div class="title mt10">
  ...
  <span><a href="<?php echo MICROSHOP_SITE_URL.DS?>index.php?con=home&fun=goods&member_id=<?php echo $output['detail']['commend_member_id'];?>"><?php echo $lang['nc_common_more'];?></a></span> </div>
<div class="sidebar-style01">
  ...
  <ul>
    ...
    <li>
      <div class="picture"><span class="thumb size60"><i></i><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=goods&fun=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank" titel="<?php echo $value['commend_goods_name'];?>">
...
<div class="title mt50">
  ...
  <span><a href="<?php echo MICROSHOP_SITE_URL.DS?>index.php?con=home&fun=personal&member_id=<?php echo $output['detail']['commend_member_id'];?>"><?php echo $lang['nc_common_more'];?></a></span> </div>
<div class="sidebar-style02">
  ...
  <ul id="pinterest">
    ...
    <li class="show">
    <div class="picture"> 
        <a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=personal&fun=detail&personal_id=<?php echo $value['personal_id'];?>" target="_blank">
