...
<ul id="indexPersonal" class="jcarousel-skin-personal">
    ...
    <li>
    <div class="cms-thumb"><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=personal&fun=detail&personal_id=<?php echo $value['personal_id'];?>">
    ...
    <dl>
        ...
        <dd class="member-id"><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=home&member_id=<?php echo $value['commend_member_id'];?>"> <?php echo $value['member_name'];?></a></dd>
