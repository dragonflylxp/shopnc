...
<div class="commend-goods">
  <div class="commend-goods-info">
    <div class="user">
      ...
      <dl>
        <dt><a href="<?php echo MICROSHOP_SITE_URL;?>/index.php?con=home&member_id=<?php echo $output['detail']['commend_member_id'];?>" target="_blank" nctype="mcard" data-param="{'id':<?php echo $output['detail']['member_id'];?>}"> <?php echo $output['detail']['member_name'];?></a><?php echo $lang['microshop_text_commend_goods'];?><span class="add-time"><?php echo date('Y-m-d',$output['detail']['commend_time']);?></span></dt>
        <dd><i></i>
