...
<div class="ncd-login-form">
  <form id="delivery_login" method="post" action="<?php echo DELIVERY_SITE_URL;?>/index.php?con=login">
    ...
    <div class="form-item"><label class="phrases">密&nbsp;&nbsp;&nbsp;&nbsp;码</label>
      ...
      <span></span></div>
      <div class="form-item"><label class="phrases">验证码</label>
          <input class="input-txt" type="text" name="captcha" id="captcha" />
          <span style="left:296px;bottom:36px; width: 90px"><a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?con=seccode&fun=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><em>点击刷新</em></a><img src="index.php?con=seccode&fun=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"> </span></div>
    <input type="submit" class="submit" value="登&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;录">
  </form>
  <a href="index.php?con=joinin" class="register">加盟物流自提服务站</a> </div>
