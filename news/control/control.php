...
class CMSControl{
    ...
    const PICTURE = 2;
    //用户中心文章列表页
    const CMS_MEMBER_ARTICLE_URL = 'index.php?con=member_article&fun=article_list';
    const CMS_MEMBER_PICTURE_URL = 'index.php?con=member_picture&fun=picture_list';
    ...
    public function __construct(){
         ...
         * seo
         */
        Tpl::output('html_title',C('cms_seo_title').'-'.C('site_name').' - Powered by shopec');
