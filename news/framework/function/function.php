...
function getPictureImageUrl($picture_id) {
    return CMS_SITE_URL.DS.'index.php?con=picture&fun=picture_detail_image&picture_id='.$picture_id;
}
...
function getGoodsUrl($goods_id) {
    return SHOP_SITE_URL.DS.'index.php?con=goods&goods_id='.$goods_id;
}
