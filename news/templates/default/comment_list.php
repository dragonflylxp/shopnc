...
<dl>
  <dt><span class="thumb"><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_snshome&mid=<?php echo $value['comment_member_id'];?>" target="_blank"> <img src="<?php echo getMemberAvatar($value['member_avatar']);?>" alt="<?php echo $value['member_name'];?>"/></a></span></dt>
  <dd>
    <p class="comment-user"><a href="<?php echo SHOP_SITE_URL;?>/index.php?con=member_snshome&mid=<?php echo $value['comment_member_id'];?>" target="_blank"> <?php echo $value['member_name'];?></a><em>发表于<?php echo date('Y-m-d H:i:s',$value['comment_time']);?></em>
    </p>
