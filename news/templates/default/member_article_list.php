...
<div class="cms-member-layout">
  <div class="cms-member-sidebar">
    ...
    <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=publish&fun=publish_article" class="contribute-btn"><?php echo $lang['cms_article_publish'];?></a>
    <ul class="cms-member-menu">
      <li <?php echo $_GET['fun']=='article_list'?' class="current"':'';?>><a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=article_list"><i class="a"></i><?php echo $lang['cms_my_article'];?></a></li>
      <li <?php echo $_GET['fun']=='draft_list'?' class="current"':'';?>><a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=draft_list"><i class="b"></i><?php echo $lang['cms_text_draft'];?></a></li>
      <li <?php echo $_GET['fun']=='recycle_list'?' class="current"':'';?>><a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=recycle_list"><i class="c"></i><?php echo $lang['cms_text_recycle'];?></a></li>
    </ul>
  </div>
      ...
      <thead>
        ...
        <tr>
          <td colspan="10"><form action="" method="get">
              <input name="con" type="hidden" value="member_article" />
              <input name="fun" type="hidden" value="<?php echo $_GET['fun'];?>" />
              <?php if($_GET['fun'] == 'article_list') { ?>
        ...
        <tr>
          ...
          <td class="handle">
            <?php if($value['article_state'] != '3') {?>
              <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=article&fun=article_detail&article_id=<?php echo $value['article_id'];?>" target="_blank" style="color:#06C;"><?php echo $lang['cms_text_view'];?></a>
              <?php } else { ?>
              <a href="<?php echo $article_url;?>" target="_blank" style="color:#06C;"><?php echo $lang['cms_text_view'];?></a>
              <?php } ?>
            <?php if($_GET['fun'] == 'draft_list') {?>
            <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=article_publish&article_id=<?php echo $value['article_id'];?>" onclick="javascript:return confirm('<?php echo $lang['cms_publish_confirm'];?>')" style="color:#390;"><?php echo $lang['cms_text_publish'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=article_edit&article_id=<?php echo $value['article_id'];?>" style="color:#F90;" ><?php echo $lang['cms_text_edit'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=article_recycle&article_id=<?php echo $value['article_id'];?>" style="color:#F36;"><?php echo $lang['cms_text_remove'];?></a>
            <?php } ?>
            <?php if($_GET['fun'] == 'recycle_list') {?>
            <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=article_draft&article_id=<?php echo $value['article_id'];?>" style="color:#639;"><?php echo $lang['cms_text_back'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_article&fun=article_drop&article_id=<?php echo $value['article_id'];?>" onclick="javascript:return confirm('<?php echo $lang['cms_delete_confirm'];?>')" style="color:#F00;"><?php echo $lang['cms_delete'];?></a>
            <?php } ?></td>
        </tr>
            <?php if($_GET['fun'] == 'draft_list') {?>
