...
<div class="cms-member-layout">
  <div class="cms-member-sidebar">
    ...
    <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=publish&fun=publish_picture" class="contribute-btn"><?php echo $lang['cms_picture_publish'];?></a>
    <ul class="cms-member-menu">
      <li <?php echo $_GET['fun']=='picture_list'?' class="current"':'';?>><a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=picture_list"><i class="a"></i><?php echo $lang['cms_my_picture'];?></a></li>
      <li <?php echo $_GET['fun']=='draft_list'?' class="current"':'';?>><a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=draft_list"><i class="b"></i><?php echo $lang['cms_text_draft'];?></a></li>
      <li <?php echo $_GET['fun']=='recycle_list'?' class="current"':'';?>><a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=recycle_list"><i class="c"></i><?php echo $lang['cms_text_recycle'];?></a></li>
    </ul>
  </div>
      ...
      <thead>
        ...
        <tr>
          <td colspan="10"><form action="" method="get">
              <input name="con" type="hidden" value="member_picture" />
              <input name="fun" type="hidden" value="<?php echo $_GET['fun'];?>" />
              <?php if($_GET['fun'] == 'picture_list') { ?>
        ...
        <tr>
          ...
          <td class="handle">
            <?php if($value['picture_state'] != '3') {?>
              <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=picture&fun=picture_detail&picture_id=<?php echo $value['picture_id'];?>" target="_blank" style="color:#06C;"><?php echo $lang['cms_text_view'];?></a>
              <?php } else { ?>
              <a href="<?php echo $picture_url;?>" target="_blank" style="color:#06C;"><?php echo $lang['cms_text_view'];?></a>
              <?php } ?>
            <?php if($_GET['fun'] == 'draft_list') {?>
            <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=picture_publish&picture_id=<?php echo $value['picture_id'];?>" onclick="javascript:return confirm('<?php echo $lang['cms_publish_confirm'];?>')" style="color:#390;"><?php echo $lang['cms_text_publish'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=picture_edit&picture_id=<?php echo $value['picture_id'];?>" target="_blank" style="color:#F90;" ><?php echo $lang['cms_text_edit'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=picture_recycle&picture_id=<?php echo $value['picture_id'];?>" style="color:#F36;"><?php echo $lang['cms_text_remove'];?></a>
            <?php } ?>
            <?php if($_GET['fun'] == 'recycle_list') {?>
            <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=picture_draft&picture_id=<?php echo $value['picture_id'];?>" style="color:#639;"><?php echo $lang['cms_text_back'];?></a> <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=member_picture&fun=picture_drop&picture_id=<?php echo $value['picture_id'];?>" onclick="javascript:return confirm('<?php echo $lang['cms_delete_confirm'];?>')" style="color:#F00;"><?php echo $lang['cms_delete'];?></a>
            <?php } ?></td>
        </tr>
            <?php if($_GET['fun'] == 'draft_list') {?>
