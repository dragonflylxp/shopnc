...
<header id="topHeader">
  <div class="warp-all">
    ...
    <div class="search-cms" id="searchCMS">
      <ul class="tab">
        <li <?php if($_GET['con'] != 'picture' ) echo 'class="current"'; ?> action="<?php echo CMS_SITE_URL.DS;?>index.php" con="article" fun="article_search"><?php echo $lang['cms_article'];?><i></i></li>
        <li <?php if($_GET['con'] == 'picture' ) echo 'class="current"'; ?> action="<?php echo CMS_SITE_URL.DS;?>index.php" con="picture" fun="picture_search"><?php echo $lang['cms_picture'];?><i></i></li>
        <li action="<?php echo SHOP_SITE_URL.DS;?>index.php" con="search"><?php echo $lang['cms_goods'];?><i></i></li>
      </ul>
      <div class="form-box">
