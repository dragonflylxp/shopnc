...
<div class="warp-all picture-layout-a">
  <div class="sitenav-bar">
    <div class="sitenav"><?php echo $lang['current_location'];?><?php echo $lang['nc_colon'];?> <a href="<?php echo CMS_SITE_URL;?>"><?php echo $lang['cms_site_name'];?></a> > <a href="<?php echo CMS_SITE_URL.DS.'index.php?con=picture&fun=picture_list';?>"><?php echo $lang['cms_picture'];?></a></div>
  </div>
  ...
  <div class="mainbox">
    <div class="picture-detail-content">
      ...
      <div class="picture-keyword"><?php echo $lang['cms_keyword'];?><?php echo $lang['nc_colon'];?>
        ...
        <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=picture&fun=picture_search&keyword=<?php echo $value;?>" target="_blank"><?php echo $value;?></a>
        <?php } ?>
        <?php } ?>
      </div>
    ...
    <div class="picture-detail-sidebar">
      <div class="picture-tag">
        ...
        <a href="<?php echo CMS_SITE_URL.DS.'index.php?con=picture&fun=picture_tag_search&tag_id='.$value['tag_id'];?>"><?php echo $value['tag_name'];?></a>
        <?php } ?>
        <?php } ?>
      </div>
