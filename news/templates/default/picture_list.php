...
<div class="warp-all picture-layout-b">
  <div class="sitenav-bar">
    <div class="sitenav"><?php echo $lang['current_location'];?><?php echo $lang['nc_colon'];?> <a href="<?php echo CMS_SITE_URL;?>"><?php echo $lang['cms_site_name'];?></a> > <a href="<?php echo CMS_SITE_URL.DS.'index.php?con=picture&fun=picture_list';?>"><?php echo $lang['cms_picture'];?></a> <?php echo empty($_GET['class_id'])?'':' > '.$output['picture_class_list'][$_GET['class_id']]['class_name'];?></div>
  </div>
  <div class="mainbox">
