...
<div class="warp-all article-layout-a">
  <div class="mainbox">
    <div class="sitenav-bar">
      <div class="sitenav"><?php echo $lang['current_location'];?><?php echo $lang['nc_colon'];?> <a href="<?php echo CMS_SITE_URL;?>"><?php echo $lang['cms_site_name'];?></a> > <a href="<?php echo CMS_SITE_URL.DS.'index.php?con=article&fun=article_list';?>"><?php echo $lang['cms_article'];?></a></div>
    </div>
    <article class="article-detail-content">
      <header id="articleTool-holder">
        <h1 class="article-title"><a href="<?php echo $url_function($_GET[$_GET['con'].'_id']);?>"><?php echo $output[$_GET['con'].'_detail'][$_GET['con'].'_title'];?></a></h1>
    ...
    <div class="block-style-one">
      ...
      <div class="content">
        <ul class="cms-hot-comment-list">
          ...
          <li><em><?php echo $value[$_GET['con'].'_comment_count'];?></em><a href="<?php echo $url_function($value[$_GET['con'].'_id']);?>"><?php echo $value[$_GET['con'].'_title'];?></a></li>
          <?php } ?>
          <?php } ?>
        </ul>
      </div>
    ...
    <div class="block-style-one">
      ...
      <div class="content">
        ...
        <ul class="article-recommand-list">
          ...
          <li><a href="index.php?con=article&fun=article_list&class_id=<?php echo $value['class_id'];?>" class="class" target="_blank">[<?php echo $value['class_name'];?>]</a><a href="<?php echo getCMSArticleUrl($value['article_id']);?>"><?php echo $value['article_title'];?></a></li>
