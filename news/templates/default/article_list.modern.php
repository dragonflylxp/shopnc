...
<div class="sitenav-bar">
        <div class="sitenav"><?php echo $lang['current_location'];?><?php echo $lang['nc_colon'];?> <a href="<?php echo CMS_SITE_URL;?>"><?php echo $lang['cms_site_name'];?></a> > <a href="<?php echo CMS_SITE_URL.DS.'index.php?con=article&fun=article_list';?>"><?php echo $lang['cms_article'];?></a><?php echo empty($_GET['class_id'])?'':' > '.$output['article_class_list'][$_GET['class_id']]['class_name'];?></div>
  <div class="browse-list-modern"><a href="index.php?con=article&fun=article_list&class_id=<?php echo $_GET['class_id'];?>" title="<?php echo $lang['cms_classical'];?>">&nbsp;</a><span title="<?php echo $lang['cms_modern'];?>"><?php echo $lang['cms_modern'];?></span></span></div>
</div>
      ...
      <div class="modern-list-tag block-style-two">
        ...
        <div class="content">
          <div class="tag-cloud">
            ...
            <a href="<?php echo CMS_SITE_URL.DS.'index.php?con=article&fun=article_tag_search&tag_id='.$value['tag_id'];?>"><?php echo $value['tag_name'];?></a>
            <?php } ?>
            <?php } ?>
          </div>
        </div>
        ...
        <div class="modern-list-item">
          ...
          <div class="article-tag"><?php echo $lang['cms_keyword'];?><?php echo $lang['nc_colon'];?>
            ...
            <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=article&fun=article_search&keyword=<?php echo rawurlencode($value);?>" target="_blank"><?php echo $value;?></a>
            <?php } ?>
            <?php } ?>
          </div>
        </div>
