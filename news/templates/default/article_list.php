...
<div class="warp-all article-layout-a">
  <div class="mainbox">
    <div class="sitenav-bar">
      ...
      <div class="browse-list"><span title="<?php echo $lang['cms_classical'];?>"><?php echo $lang['cms_classical'];?></span><a href="index.php?con=article&fun=article_list&class_id=<?php echo $_GET['class_id'];?>&type=modern" title="<?php echo $lang['cms_modern'];?>">&nbsp;</a></span></div>
    </div>
