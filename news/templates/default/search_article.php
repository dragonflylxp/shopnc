...
<div class="warp-all article-layout-a">
  <div class="mainbox">
    <div class="sitenav-bar">
      <div><?php echo $lang['current_location'];?><?php echo $lang['nc_colon'];?> <a href="<?php echo CMS_SITE_URL;?>"><?php echo $lang['cms_site_name'];?></a> > <a href="<?php echo CMS_SITE_URL.DS.'index.php?con=article&fun=article_list';?>"><?php echo $lang['cms_article'];?></a> > <?php echo $lang['cms_search_result'];?></div>
    ...
    <ul class="article-search-list">
      ...
      <li>
        ...
        <div class="article-tag"><?php echo $lang['cms_keyword'];?><?php echo $lang['nc_colon'];?>
          ...
          <a href="<?php echo CMS_SITE_URL.DS;?>index.php?con=article&fun=article_search&keyword=<?php echo rawurlencode($keyword_value);?>" target="_blank"><?php echo $keyword_value;?></a>
          <?php } ?>
          <?php } ?>
        </div>
