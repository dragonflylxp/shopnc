...
class zhiboControl extends mobileHomeControl {
    ...
    private  function  _get_Own_Store_List(){
        ...
        foreach($store_list as $kki=>$vvi){
		    ...
		    if($cssd){
				$simply_store_list[$kki]['img'] = UPLOAD_SITE_URL.DS.ATTACH_STORE.DS.$vvi['store_id'].DS."zb_show.jpg";
		    }else{
				$simply_store_list[$kki]['img'] = UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.C('default_store_logo');
			}       	
        }		
